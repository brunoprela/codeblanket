...
export const kafkaConsumersMC: MultipleChoiceQuestion[] = [
  {
    ...
    options: [
      { id: 'a', text: 'All messages are lost' },
      { id: 'b', text: 'The consumer group is disbanded' },
      {
        id: 'c',
        text: "Rebalancing occurs, reassigning the failed consumer's partitions to remaining consumers",
      },
      {
        id: 'd',
        text: 'Messages are automatically routed to a dead letter queue',
      },
    ],
    correctAnswer: 'c',
    explanation:
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: 'commitSync() is faster than commitAsync()' },
      {
        id: 'b',
        text: 'commitSync() blocks until the commit succeeds, commitAsync() returns immediately without waiting',
      },
      {
        id: 'c',
        text: 'commitSync() commits to all brokers, commitAsync() commits to one broker only',
      },
      {
        id: 'd',
        text: 'commitSync() is used for manual commits, commitAsync() is automatic',
      },
    ],
    correctAnswer: 'b',
    explanation:
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: 'To improve processing speed' },
      {
        id: 'b',
        text: 'To handle duplicate message delivery gracefully without side effects',
      },
      { id: 'c', text: 'To reduce memory usage' },
      { id: 'd', text: 'To enable automatic retries' },
    ],
    correctAnswer: 'b',
    explanation:
  ...
  },
  {
    ...
    options: [
      {
        id: 'a',
        text: 'The time delay between message production and consumption',
      },
      {
        id: 'b',
        text: "The difference between the latest offset in a partition and the consumer's committed offset",
      },
      { id: 'c', text: 'The number of consumers that are offline' },
      { id: 'd', text: 'The time taken for rebalancing to complete' },
    ],
    correctAnswer: 'b',
    explanation:
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: 'Maximum time to wait for new messages in a poll' },
      {
        id: 'b',
        text: 'Maximum time between poll() calls before the consumer is considered dead',
      },
      { id: 'c', text: 'Maximum time to wait for offset commit' },
      { id: 'd', text: 'Maximum time for rebalancing' },
    ],
    correctAnswer: 'b',
    explanation:
