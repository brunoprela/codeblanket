...
export const messageSchemaEvolutionMC: MultipleChoiceQuestion[] = [
  {
    ...
    options: [
      ...
      'All consumers must be updated simultaneously',
  ...
  },
  {
    ...
    options: [
      ...
      'To centrally store and validate message schemas, ensuring compatibility',
  ...
  },
  {
    ...
    options: [
      ...
      'Avro provides compact binary encoding and built-in schema evolution support',
      'Avro is easier to debug',
      "Avro doesn't require schemas",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Both backward and forward compatible (new consumers read old messages, old consumers read new messages)',
