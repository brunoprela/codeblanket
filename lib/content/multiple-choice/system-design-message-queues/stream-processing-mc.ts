...
export const streamProcessingMC: MultipleChoiceQuestion[] = [
  {
    ...
    options: [
      'Stream processing is slower than batch processing',
      'Stream processing operates on data as it arrives (continuous), batch processing operates on bounded datasets (periodic)',
      'Stream processing uses more memory than batch processing',
      'They are the same',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'A fixed-size, non-overlapping time-based window',
      'A window based on inactivity gaps',
      'A window that grows dynamically',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'A mechanism to track event-time progress and handle late-arriving data',
  ...
  },
  {
    ...
    options: [
      'To cache messages for faster processing',
      'To maintain aggregations, counts, or other computations across multiple events',
      'To compress data',
  ...
  },
  {
    ...
    options: [
      ...
      'Each input event affects the output exactly once, even if failures occur',
