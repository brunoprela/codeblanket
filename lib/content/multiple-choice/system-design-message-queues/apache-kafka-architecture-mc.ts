...
export const apacheKafkaArchitectureMC: MultipleChoiceQuestion[] = [
  {
    ...
    options: [
      { id: 'a', text: 'To encrypt messages for security' },
      {
        id: 'b',
        text: 'To enable parallel processing and horizontal scalability',
      },
      { id: 'c', text: 'To automatically compress messages' },
      { id: 'd', text: 'To replicate messages across data centers' },
    ],
    correctAnswer: 'b',
    explanation:
  ...
  },
  {
    ...
    options: [
      {
        id: 'a',
        text: 'It determines how many times a message is sent to consumers',
      },
      {
        id: 'b',
        text: 'It specifies the number of copies of each partition maintained across brokers for fault tolerance',
      },
      { id: 'c', text: 'It controls the compression level for messages' },
      {
        id: 'd',
        text: 'It sets the number of consumer groups that can read from a topic',
      },
    ],
    correctAnswer: 'b',
    explanation:
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: 'To compress messages before storing them' },
      {
        id: 'b',
        text: 'To enable load balancing among multiple consumers of the same application',
      },
      { id: 'c', text: 'To replicate messages across brokers' },
      { id: 'd', text: 'To manage producer connections to brokers' },
    ],
    correctAnswer: 'b',
    explanation:
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: 'They are immediately deleted' },
      {
        id: 'b',
        text: 'They remain in the log for a configured retention period, regardless of consumption',
      },
      { id: 'c', text: 'They are moved to a separate archive topic' },
      { id: 'd', text: 'They are compressed to save storage' },
    ],
    correctAnswer: 'b',
    explanation:
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: 'Unlimited consumers' },
      { id: 'b', text: '1 consumer' },
      { id: 'c', text: '8 consumers' },
      { id: 'd', text: '16 consumers' },
    ],
    correctAnswer: 'c',
    explanation:
