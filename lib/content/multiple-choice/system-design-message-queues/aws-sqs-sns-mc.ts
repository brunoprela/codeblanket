...
export const awsSqsSnsMC: MultipleChoiceQuestion[] = [
  {
    ...
    options: [
      { id: 'a', text: 'Standard is faster, FIFO guarantees message ordering' },
      { id: 'b', text: 'Standard is cheaper, FIFO is more expensive' },
      {
        id: 'c',
        text: 'Standard queues guarantee ordering, FIFO queues do not',
      },
      {
        id: 'd',
        text: 'Standard queues have unlimited throughput and best-effort ordering, FIFO queues guarantee strict ordering but limited to 3000 messages/sec',
      },
    ],
    correctAnswer: 'd',
    explanation:
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: 'Time before a message is automatically deleted' },
      {
        id: 'b',
        text: 'Time during which a message is invisible to other consumers after being received',
      },
      { id: 'c', text: 'Maximum time a message can stay in the queue' },
      { id: 'd', text: 'Time between message receives' },
    ],
    correctAnswer: 'b',
    explanation:
  ...
  },
  {
    ...
    options: [
      {
        id: 'a',
        text: 'SNS sends each message to one randomly selected SQS queue',
      },
      {
        id: 'b',
        text: 'SNS broadcasts each message to all subscribed SQS queues simultaneously',
      },
      { id: 'c', text: 'SNS compresses messages before sending to SQS' },
      { id: 'd', text: 'SNS routes messages based on message content' },
    ],
    correctAnswer: 'b',
    explanation:
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: 'To permanently archive all messages' },
      {
        id: 'b',
        text: 'To store messages that fail processing after a specified number of attempts',
      },
      { id: 'c', text: 'To speed up message delivery' },
      { id: 'd', text: 'To replicate messages across regions' },
    ],
    correctAnswer: 'b',
    explanation:
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: 'Receiving messages in larger batches' },
      {
        id: 'b',
        text: 'Waiting up to 20 seconds for messages to arrive instead of returning immediately if queue is empty',
      },
      { id: 'c', text: 'Keeping messages in the queue longer' },
      { id: 'd', text: 'Polling multiple queues simultaneously' },
    ],
    correctAnswer: 'b',
    explanation:
