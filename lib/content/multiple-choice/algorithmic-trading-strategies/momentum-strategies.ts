export const momentumStrategiesMC = [
  {
    id: 'ats-6-mc-1',
    question:
      'Why do momentum strategies skip the last month when calculating returns?',
    options: [
      'To reduce transaction costs',
      'To avoid short-term reversal effect',
      'To increase holding period',
...
Historical performance (1927-2024): Sharpe 0.8-1.2, annual return 10-15%, max drawdown -50% (2009). Momentum is robust but has crash risk.`,
  },
  {
    ...
    options: [
      'Market goes up',
      'Winners reverse to losers overnight',
...
2009 Q1: Biggest losers (financials -80% in 2008) became biggest winners (+100% in Q1 2009). Momentum portfolios (short financials) crashed -50%.`,
  },
  {
    ...
    options: [
      'Uses shorter lookback period',
      'Trades each asset independently (not relative)',
      'Only works in equities',
      'Has lower Sharpe ratio',
    ],
    correctAnswer: 1,
...
Cross-sectional: rank assets, long top vs short bottom (relative). Time-series: long if asset up, short if down (absolute). Time-series has market beta, cross-sectional is market-neutral.`,
  },
  {
    ...
    options: [
      'Trade only high-volatility stocks',
      'Reduce positions when volatility increases',
      'Increase positions when volatility increases',
      'Avoid volatility completely',
    ],
    correctAnswer: 1,
