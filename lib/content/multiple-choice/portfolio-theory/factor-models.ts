export const factorModelsMC = {
    ...
    questions: [
        ...
        },
        {
            ...
            correctAnswer: 3,
            explanation: 'Answer: D. SMB=0.6 (positive) → small-cap tilt. HML=-0.3 (negative) → growth tilt (low book-to-market = high valuations). Combined: small-cap growth. Not large-cap (A/C - SMB positive means small-cap), not value (B - HML negative means growth not value). MKT beta 1.1 shows slightly aggressive market exposure.'
        },
        {
            id: 'fm-mc-3',
            type: 'multiple-choice' as const,
