    ...
    questions: [
        {
            ...
            question: 'Strategy with gross return 18%, turnover 200%, transaction costs 12 bps per trade. Net return?',
            options: [
                '17.76%',
                '15.60%',
                '16.80%',
        ...
        },
        {
            ...
            correctAnswer: 2,
            explanation: 'Answer: C. Sharpe collapsed 64% from in-sample to out-of-sample (1.1 → 0.4). This is severe overfitting. Good strategies degrade 10-20%, moderate overfitting 30-40%, severe >50%. The strategy learned noise, not signal. NOT robust (A), worse than moderate (B), definitely not improved (D). This backtest should be rejected - the strategy won\'t work in live trading.'
        },
        {
            id: 'bp-mc-4',
            type: 'multiple-choice' as const,
            question: 'Walk-forward analysis with 5-year training, 1-year testing, over 24 years gives:',
            options: [
