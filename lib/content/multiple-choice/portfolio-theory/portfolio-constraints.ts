  ...
  questions: [
    {
      ...
      question:
        'Which constraint reduces expected return most in typical portfolio optimization?',
      options: [
      ...
      correctAnswer: 1,
      explanation:
        'Answer: B. Position limits prevent concentration in highest-conviction ideas. Unconstrained might put 30% in top stock; 5% limit forces diversification, reducing return ~2-4%. Turnover (A) costs ~0.5%, sector limits (C) ~0.3%, factor constraints (D) ~0.2%. Position limits most restrictive because alpha typically concentrated in top 10-20 stocks. Diversification improves risk but sacrifices return.',
    },
    {
      id: 'pc-mc-2',
      type: 'multiple-choice' as const,
      question:
        'Shadow price (Lagrange multiplier) of 0.15 for sector constraint means:',
      options: [
