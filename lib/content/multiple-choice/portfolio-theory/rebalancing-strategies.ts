export const rebalancingStrategiesMC = {
    ...
    questions: [
        ...
        },
        {
            ...
            correctAnswer: 1,
            explanation: 'Answer: B. Rebalance in IRA/401k first (no capital gains tax). Then use new contributions (tax-free). Then tax-loss harvest in taxable. Last resort: sell winners (triggers tax). NOT selling winners first (A - that\'s tax-inefficient!), not frequent rebalancing (C - increases taxable events), derivatives (D - possible but complex, not primary strategy). Hierarchy: IRA first, contributions second, TLH third, sales last.'
        },
        {
            id: 'rs-mc-5',
            type: 'multiple-choice' as const,
            question: 'Threshold rebalancing with 5% bands is generally superior to monthly calendar rebalancing because:',
            options: [
