    ...
    questions: [
        {
            ...
            question: 'For 1000-stock portfolio, covariance matrix estimation with 5 years daily data requires storing:',
            options: [
                '500,000 data points',
            ...
            correctAnswer: 2,
            explanation: 'Answer: C. 1000 stocks × 1250 trading days (5 years × ~250 days) = 1,250,000 return observations. Covariance matrix itself has N(N+1)/2 = 500,500 unique elements. Storage: 1.25M returns (10MB) + 500K covariances (4MB) ≈ 14MB. Manageable. NOT 500K (A), not 1M (B - close but incorrect math), not 5M (D - too high). The math: N stocks × T time periods = 1000 × 1250.'
        },
        {
            id: 'pop-mc-2',
            type: 'multiple-choice' as const,
            question: 'CVXPY optimization with 1000 variables and 200 constraints typically solves in:',
            options: [
        ...
        },
        {
            ...
            correctAnswer: 0,
            explanation: 'Answer: A. Reasonable production targets for financial optimization: p50 <5s (most requests fast), p95 <10s (handle 95% within 10s), 99% uptime (8.7 hours downtime annually). Not <1s (B - too aggressive for 1000-stock optimization), not <0.1s (C - impossible for complex optimization), not 10s/60s (D - too slow, 95% uptime inadequate). These targets balance performance, cost, and reliability.'
        },
        {
            id: 'pop-mc-5',
            type: 'multiple-choice' as const,
