export const meanVarianceOptimizationMC = {
  ...
  questions: [
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        "Answer: B. Black-Litterman starts with equilibrium returns (reverse-optimized from market weights), then incorporates investor views with appropriate uncertainty. This avoids starting from noisy historical means. Doesn't use faster algorithms (A), still needs covariance matrix (C), and definitely doesn't guarantee positive returns (D). The key innovation is using market equilibrium as prior.",
    },
    {
      id: 'mvo-mc-4',
      type: 'multiple-choice' as const,
      question:
        'Shrinkage estimators for expected returns typically shrink toward:',
      options: [
        'Zero',
        'Risk-free rate',
