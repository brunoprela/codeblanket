export const assetAllocationStrategiesMC = {
    ...
    questions: [
        ...
        },
        {
            ...
            correctAnswer: 2,
            explanation: 'Answer: C. CAPE (cyclically-adjusted P/E) is a valuation metric. High CAPE suggests overvaluation → reduce equities (mean reversion). Low CAPE suggests undervaluation → increase equities. Evidence: CAPE has predictive power for 10-year returns (R² ≈ 0.4). Not pure market timing (A - broader term), not momentum (B - that\'s trend-following), not factor timing (D - that\'s rotating between factors).'
        },
        {
            id: 'aas-mc-5',
            type: 'multiple-choice' as const,
            question: 'Target-date 2050 fund appropriate for 35-year-old (15 years to retirement) should have approximately:',
            options: [
