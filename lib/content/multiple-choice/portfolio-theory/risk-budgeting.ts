export const riskBudgetingMC = {
    ...
    questions: [
        ...
        },
        {
            ...
            correctAnswer: 2,
            explanation: 'Answer: C. Unlevered RP: ~9% vol, 6% return (bond-heavy). 60/40: ~11% vol, 7.5% return. RP has LOWER returns and LOWER risk due to heavy bond allocation (often 50-70% bonds). To match 60/40 risk, need 1.2-1.4x leverage, costing 0.5-1% in borrowing costs. Levered RP can match 60/40 returns with similar risk, but unlevered underperforms on returns (though better downside protection).'
        },
        {
            id: 'rb-mc-4',
            type: 'multiple-choice' as const,
            question: 'Custom risk budget allocating 60% risk to equities, 40% to bonds (from equal weights) implies:',
            options: [
        ...
        },
        {
            id: 'rb-mc-5',
            type: 'multiple-choice' as const,
            question: 'Factor risk budgeting is superior to asset risk budgeting because:',
            options: [
