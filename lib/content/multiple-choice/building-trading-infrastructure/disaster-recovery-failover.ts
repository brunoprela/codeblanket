export const disasterRecoveryFailoverMC = [
  ...
  },
  {
    ...
    question: 'What is database "streaming replication"?',
    options: [
  ...
  },
  {
    ...
    question: 'How often should you test your disaster recovery plan?',
    options: [
  ...
  },
  {
    ...
    options: ['Backup', 'Replication', 'Failover', 'Load balancing'],
    correctAnswer: 2,
    explanation:
      'Answer: Failover.\n\n' +
