export const messageQueuesTradingMC = [
  {
    ...
    options: ['RabbitMQ', 'Kafka', 'Redis Pub/Sub', 'PostgreSQL LISTEN/NOTIFY'],
    correctAnswer: 1,
    explanation:
      'Answer: Kafka.\n\n' +
  ...
  },
  {
    ...
    question: 'What does "message acknowledgment" (ACK) mean in RabbitMQ?',
    options: [
  ...
  },
  {
    ...
    question: 'What is the advantage of ZeroMQ over Kafka for trading systems?',
    options: [
      'Higher throughput',
      'Better persistence',
      'Lower latency (<10μs)',
  ...
  },
  {
    ...
    options: ['RabbitMQ', 'Kafka', 'ZeroMQ', 'Redis Pub/Sub'],
    correctAnswer: 1,
    explanation:
      'Answer: Kafka.\n\n' +
