...
export const stripearchitectureMultipleChoice: MultipleChoiceQuestion[] = [
    {
        id: 'mc1',
        question: 'How long does Stripe store idempotency keys in cache for payment requests?',
        options: [
