...
export const airbnbarchitectureMultipleChoice: MultipleChoiceQuestion[] = [
    {
        id: 'mc1',
        question: 'Which search technology does Airbnb use for its listing search with complex filters?',
        options: [
    ...
    {
        id: 'mc2',
        question: 'How does Airbnb handle calendar availability checking for search queries?',
        options: [
    ...
    },
    {
        ...
        correctAnswer: 2,
        explanation: 'Airbnb charges guests a 14% service fee and hosts a 3% service fee (percentages may vary by region/promotion). For a $1500 booking, the guest pays ~$210 service fee ($1710 total), and the host receives $1455 after Airbnb\'s $45 fee. This fee structure covers payment processing, customer support, insurance, and platform operations. Payments are held in escrow with a 24-hour cancellation window before releasing to hosts.',
    },
    {
        id: 'mc4',
