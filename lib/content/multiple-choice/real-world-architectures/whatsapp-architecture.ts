...
export const whatsapparchitectureMultipleChoice: MultipleChoiceQuestion[] = [
    {
        ...
        correctAnswer: 2,
        explanation: 'WhatsApp uses the Signal Protocol with Double Ratchet algorithm for end-to-end encryption. Each message has its own encryption key derived through ratcheting, providing forward secrecy (compromising today\'s key doesn\'t reveal past messages). The server routes encrypted messages but never has decryption keys. Users can verify encryption by comparing safety numbers (key fingerprints) to prevent man-in-the-middle attacks.',
    },
    {
        id: 'mc2',
        question: 'What programming language and framework is WhatsApp primarily built on?',
        options: [
        ...
        correctAnswer: 1,
        explanation: 'WhatsApp is built on Erlang/OTP (Open Telecom Platform). Erlang\'s lightweight processes enable millions of concurrent connections per server (2-3M, 10x industry average). The Actor model simplifies distributed systems, and OTP provides fault tolerance patterns. Mnesia, Erlang\'s in-memory distributed database, stores user sessions and routing tables with microsecond latency. This architecture enables 50 engineers to handle 100 billion messages daily.',
    },
    {
        id: 'mc3',
        question: 'How many concurrent connections can one WhatsApp server typically handle?',
        options: [
