...
export const twitterarchitectureMultipleChoice: MultipleChoiceQuestion[] = [
    {
        ...
        correctAnswer: 1,
        explanation: 'Snowflake IDs are 64-bit: 1 bit unused (always 0), 41 bits timestamp (milliseconds since epoch, good until 2079), 10 bits machine ID (1024 machines), 12 bits sequence (4096 IDs per machine per millisecond). This structure ensures time-ordered IDs, global uniqueness without coordination, and high throughput. Each machine generates IDs independently without bottlenecks.',
    },
    {
        id: 'mc2',
        question: 'Why does Twitter use fanout-on-read for celebrity accounts in timeline generation?',
        options: [
    ...
    },
    {
        ...
        correctAnswer: 2,
        explanation: 'Twitter originally used MySQL but migrated to Manhattan (their custom distributed database). MySQL struggled with write scalability and multi-datacenter replication at Twitter\'s scale. Manhattan provides horizontal scalability, multi-datacenter replication, tunable consistency, and is optimized for Twitter\'s access patterns (timeline storage, user graphs, tweet metadata). It handles millions of operations per second across multiple datacenters.',
    },
    {
        id: 'mc5',
        question: 'How does Twitter ensure tweet delivery consistency in its distributed architecture?',
        options: [
