...
export const youtubearchitectureMultipleChoice: MultipleChoiceQuestion[] = [
    {
        id: 'mc1',
        question: 'How many formats and resolutions does YouTube typically generate for each uploaded video?',
        options: [
