...
export const zoomarchitectureMultipleChoice: MultipleChoiceQuestion[] = [
    {
        id: 'mc1',
        question: 'What video routing architecture does Zoom use for small meetings (2-40 participants)?',
        options: [
        ...
        correctAnswer: 1,
        explanation: 'Zoom uses SFU (Selective Forwarding Unit) mode for small meetings (2-40 participants). Each participant sends one video stream to Zoom\'s Multimedia Router (SFU), which forwards streams to other participants without transcoding. Participants upload 1 stream and download N-1 streams. This balances latency, quality, and bandwidth better than P2P (which becomes impractical beyond 4-5 participants) or MCU (which requires server CPU for compositing).',
    },
    {
        id: 'mc2',
