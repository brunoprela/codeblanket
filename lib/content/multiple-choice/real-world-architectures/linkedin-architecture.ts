...
export const linkedinarchitectureMultipleChoice: MultipleChoiceQuestion[] = [
    ...
    },
    {
        ...
        correctAnswer: 2,
        explanation: 'Brooklin is LinkedIn\'s tool for cross-datacenter data replication. It provides reliable, scalable replication of data between datacenters with configurable consistency models. Brooklin works with various data sources (Espresso, Kafka, databases) and ensures that data changes are propagated across LinkedIn\'s global infrastructure. It complements Kafka for event propagation and Espresso for storage replication.',
    },
    {
        id: 'mc3',
