...
export const dropboxarchitectureMultipleChoice: MultipleChoiceQuestion[] = [
  {
    id: 'mc1',
    question:
      'What is the average chunk size Dropbox uses for file deduplication?',
    options: [
  ...
  },
  {
    id: 'mc4',
    question:
      'What hashing algorithm does Dropbox use for chunk deduplication?',
    options: [
  ...
  },
  {
    id: 'mc5',
    question:
      'How long does Dropbox retain file version history for free users?',
    options: [
