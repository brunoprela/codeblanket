...
export const netflixarchitectureMultipleChoice: MultipleChoiceQuestion[] = [
  {
    id: 'mc1',
    question:
      'Which database does Netflix primarily use for its streaming infrastructure?',
    options: [
  ...
  },
  {
    id: 'mc5',
    question:
      'How many microservices does Netflix operate as part of its architecture?',
    options: [
