...
export const uberarchitectureMultipleChoice: MultipleChoiceQuestion[] = [
    {
        id: 'mc1',
        question: 'What geospatial indexing system does Uber use to efficiently find nearby drivers?',
        options: [
    ...
    },
    {
        ...
        correctAnswer: 1,
        explanation: 'DISCO (Dispatch Optimization) is Uber\'s algorithm for optimally matching drivers to delivery orders. Unlike a simple "nearest driver" greedy approach, DISCO performs batch matching every 30 seconds, considering factors like estimated pickup time, driver acceptance probability, driver quality, future demand prediction, and stacked delivery opportunities. It formulates this as an optimization problem to minimize total delivery time, resulting in 15% improvement over naive assignment.',
    },
    {
        id: 'mc3',
        question: 'How frequently does Uber\'s driver app send GPS location updates?',
        options: [
    ...
    },
    {
        ...
        correctAnswer: 1,
        explanation: 'Uber uses Cassandra for storing historical location data, partitioned by dasher_id and clustered by timestamp. This schema enables efficient queries like "get dasher location history for last hour" by querying a single partition ordered by time. Cassandra\'s high write throughput (billions of location updates daily) and scalability make it well-suited for this use case. Redis stores only current locations for low-latency queries.',
    },
];
