...
export const spotifyarchitectureMultipleChoice: MultipleChoiceQuestion[] = [
    {
        id: 'mc1',
        question: 'Which three main approaches does Spotify use for music recommendations?',
        options: [
    ...
    },
    {
        ...
        correctAnswer: 1,
        explanation: 'Spotify encodes songs in multiple bitrates: 96 kbps (low quality), 160 kbps (normal), and 320 kbps (high quality). The client selects the appropriate bitrate based on network conditions—typically 160 kbps on cellular and 320 kbps on WiFi. Songs are split into 15-second chunks, and the client prefetches the next 30-60 seconds. This balances audio quality with bandwidth usage and ensures smooth playback.',
    },
    {
        id: 'mc4',
        question: 'Which data processing technology does Spotify use for batch processing user data and generating weekly playlists?',
        options: [
            'Hadoop MapReduce',
            'Apache Spark',
            'AWS Lambda',
