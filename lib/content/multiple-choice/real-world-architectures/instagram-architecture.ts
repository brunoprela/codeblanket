...
export const instagramarchitectureMultipleChoice: MultipleChoiceQuestion[] = [
    {
        id: 'mc1',
        question: 'What database technology does Instagram primarily use for its social graph and feed data after migrating from PostgreSQL?',
        options: [
