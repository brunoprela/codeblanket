export const building_scaling_strategyMC = {
  title: 'Multiple Choice Quiz - Building Scaling Strategy',
  questions: [
    {
      question:
        'What is the primary benefit of implementing building scaling strategy in a production LLM application?',
      options: [
      ...
      correctAnswer: 1,
      explanation:
        'The primary benefit of building scaling strategy is improved performance and cost efficiency at scale. While other benefits may exist, the main goal is to handle larger workloads more effectively while controlling costs.',
    },
    {
      question:
        'When implementing building scaling strategy, what is typically the biggest challenge?',
      options: [
    ...
    {
      question:
        'In the context of building scaling strategy, what metric is most important to track?',
      options: [
      ...
      correctAnswer: 2,
      explanation:
        'Cost per request and latency are the most critical metrics for building scaling strategy. These directly measure the effectiveness of your scaling strategy and its impact on user experience and budget.',
    },
    {
      question:
        'What is a common mistake when first implementing building scaling strategy?',
      options: [
    ...
    {
      question:
        'For a production LLM application serving 100,000 users, what is a reasonable target for building scaling strategy?',
      options: [
