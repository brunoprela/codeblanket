export const model_selection_routingMC = {
  title: 'Multiple Choice Quiz - Model Selection Routing',
  questions: [
    {
      question:
        'What is the primary benefit of implementing model selection routing in a production LLM application?',
      options: [
      ...
      correctAnswer: 1,
      explanation:
        'The primary benefit of model selection routing is improved performance and cost efficiency at scale. While other benefits may exist, the main goal is to handle larger workloads more effectively while controlling costs.',
    },
    {
      question:
        'When implementing model selection routing, what is typically the biggest challenge?',
      options: [
    ...
    {
      question:
        'In the context of model selection routing, what metric is most important to track?',
      options: [
      ...
      correctAnswer: 2,
      explanation:
        'Cost per request and latency are the most critical metrics for model selection routing. These directly measure the effectiveness of your scaling strategy and its impact on user experience and budget.',
    },
    {
      question:
        'What is a common mistake when first implementing model selection routing?',
      options: [
    ...
    {
      question:
        'For a production LLM application serving 100,000 users, what is a reasonable target for model selection routing?',
      options: [
