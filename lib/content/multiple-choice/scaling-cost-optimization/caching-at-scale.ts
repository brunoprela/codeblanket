export const caching_at_scaleMC = {
  title: 'Multiple Choice Quiz - Caching At Scale',
  questions: [
    {
      question:
        'What is the primary benefit of implementing caching at scale in a production LLM application?',
      options: [
      ...
      correctAnswer: 1,
      explanation:
        'The primary benefit of caching at scale is improved performance and cost efficiency at scale. While other benefits may exist, the main goal is to handle larger workloads more effectively while controlling costs.',
    },
    {
      question:
        'When implementing caching at scale, what is typically the biggest challenge?',
      options: [
    ...
    {
      question:
        'In the context of caching at scale, what metric is most important to track?',
      options: [
      ...
      correctAnswer: 2,
      explanation:
        'Cost per request and latency are the most critical metrics for caching at scale. These directly measure the effectiveness of your scaling strategy and its impact on user experience and budget.',
    },
    {
      question:
        'What is a common mistake when first implementing caching at scale?',
      options: [
    ...
    {
      question:
        'For a production LLM application serving 100,000 users, what is a reasonable target for caching at scale?',
      options: [
