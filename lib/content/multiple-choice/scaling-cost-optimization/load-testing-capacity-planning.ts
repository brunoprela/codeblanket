export const load_testing_capacity_planningMC = {
  title: 'Multiple Choice Quiz - Load Testing Capacity Planning',
  questions: [
    {
      question:
        'What is the primary benefit of implementing load testing capacity planning in a production LLM application?',
      options: [
      ...
      correctAnswer: 1,
      explanation:
        'The primary benefit of load testing capacity planning is improved performance and cost efficiency at scale. While other benefits may exist, the main goal is to handle larger workloads more effectively while controlling costs.',
    },
    {
      question:
        'When implementing load testing capacity planning, what is typically the biggest challenge?',
      options: [
    ...
    {
      question:
        'In the context of load testing capacity planning, what metric is most important to track?',
      options: [
      ...
      correctAnswer: 2,
      explanation:
        'Cost per request and latency are the most critical metrics for load testing capacity planning. These directly measure the effectiveness of your scaling strategy and its impact on user experience and budget.',
    },
    {
      question:
        'What is a common mistake when first implementing load testing capacity planning?',
      options: [
    ...
    {
      question:
        'For a production LLM application serving 100,000 users, what is a reasonable target for load testing capacity planning?',
      options: [
