export const database_scalingMC = {
  title: 'Multiple Choice Quiz - Database Scaling',
  questions: [
    {
      question:
        'What is the primary benefit of implementing database scaling in a production LLM application?',
      options: [
      ...
      correctAnswer: 1,
      explanation:
        'The primary benefit of database scaling is improved performance and cost efficiency at scale. While other benefits may exist, the main goal is to handle larger workloads more effectively while controlling costs.',
    },
    {
      question:
        'When implementing database scaling, what is typically the biggest challenge?',
      options: [
    ...
    {
      question:
        'In the context of database scaling, what metric is most important to track?',
      options: [
      ...
      correctAnswer: 2,
      explanation:
        'Cost per request and latency are the most critical metrics for database scaling. These directly measure the effectiveness of your scaling strategy and its impact on user experience and budget.',
    },
    {
      question:
        'What is a common mistake when first implementing database scaling?',
      options: [
    ...
    {
      question:
        'For a production LLM application serving 100,000 users, what is a reasonable target for database scaling?',
      options: [
