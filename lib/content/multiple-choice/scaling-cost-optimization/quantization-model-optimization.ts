export const quantization_model_optimizationMC = {
  title: 'Multiple Choice Quiz - Quantization Model Optimization',
  questions: [
    {
      question:
        'What is the primary benefit of implementing quantization model optimization in a production LLM application?',
      options: [
      ...
      correctAnswer: 1,
      explanation:
        'The primary benefit of quantization model optimization is improved performance and cost efficiency at scale. While other benefits may exist, the main goal is to handle larger workloads more effectively while controlling costs.',
    },
    {
      question:
        'When implementing quantization model optimization, what is typically the biggest challenge?',
      options: [
    ...
    {
      question:
        'In the context of quantization model optimization, what metric is most important to track?',
      options: [
      ...
      correctAnswer: 2,
      explanation:
        'Cost per request and latency are the most critical metrics for quantization model optimization. These directly measure the effectiveness of your scaling strategy and its impact on user experience and budget.',
    },
    {
      question:
        'What is a common mistake when first implementing quantization model optimization?',
      options: [
    ...
    {
      question:
        'For a production LLM application serving 100,000 users, what is a reasonable target for quantization model optimization?',
      options: [
