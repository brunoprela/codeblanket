export const edge_computing_for_llmsMC = {
  title: 'Multiple Choice Quiz - Edge Computing For Llms',
  questions: [
    {
      question:
        'What is the primary benefit of implementing edge computing for llms in a production LLM application?',
      options: [
      ...
      correctAnswer: 1,
      explanation:
        'The primary benefit of edge computing for llms is improved performance and cost efficiency at scale. While other benefits may exist, the main goal is to handle larger workloads more effectively while controlling costs.',
    },
    {
      question:
        'When implementing edge computing for llms, what is typically the biggest challenge?',
      options: [
    ...
    {
      question:
        'In the context of edge computing for llms, what metric is most important to track?',
      options: [
      ...
      correctAnswer: 2,
      explanation:
        'Cost per request and latency are the most critical metrics for edge computing for llms. These directly measure the effectiveness of your scaling strategy and its impact on user experience and budget.',
    },
    {
      question:
        'What is a common mistake when first implementing edge computing for llms?',
      options: [
    ...
    {
      question:
        'For a production LLM application serving 100,000 users, what is a reasonable target for edge computing for llms?',
      options: [
