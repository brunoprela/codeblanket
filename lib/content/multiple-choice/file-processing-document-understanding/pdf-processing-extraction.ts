...
export const pdfprocessingextractionMultipleChoice: MultipleChoiceQuestion[] = [
  ...
  },
  {
    ...
    question: 'Which library is BEST for extracting tables from PDFs?',
    options: ['PyPDF2', 'pdfplumber', 'Pillow', 'BeautifulSoup'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    question: 'How do you extract text from a scanned PDF?',
    options: [
  ...
  },
  {
    ...
    question: "What does pdfplumber's table_settings parameter control?",
    options: [
