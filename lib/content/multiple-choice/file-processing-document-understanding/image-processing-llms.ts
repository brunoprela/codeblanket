...
export const imageprocessingllmsMultipleChoice: MultipleChoiceQuestion[] = [
    {
        ...
        question:
            'What is the purpose of image preprocessing before OCR?',
        options: [
    ...
    },
    {
        ...
        question:
            'Which vision LLM API requires images in base64 format?',
        options: [
            'Only GPT-4V',
            'Only Claude 3',
    ...
    },
    {
        ...
        question:
            'What library is commonly used for OCR in Python?',
        options: [
            'opencv-python',
            'pytesseract',
            'scikit-image',
    ...
    },
    {
        ...
        question:
            'When analyzing a complex diagram, which approach is BEST?',
        options: [
    ...
    },
    {
        ...
        question:
            'What is the recommended way to reduce vision LLM API costs?',
        options: [
