...
export const timeValueOfMoneyMultipleChoice: MultipleChoiceQuestion[] = [
  {
    ...
    options: ['$62,741', '$62,317', '$61,763', '$61,391'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['$180,000', '$400,000', '$566,764', '$612,204'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['18.00%', '18.81%', '19.56%', '19.72%'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['$133,333 (2/3 of original)', '$157,000', '$172,000', '$185,000'],
    correctAnswer: 2,
    explanation:
