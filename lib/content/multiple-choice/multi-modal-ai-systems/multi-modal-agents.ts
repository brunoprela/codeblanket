export const multimodalagentsMultipleChoice = [
  {
    id: 'mmas-multi-modal-agents-mc-1',
    question:
      'What is the recommended approach for optimizing costs in multi-modal agents systems?',
    options: [
  ...
  {
    id: 'mmas-multi-modal-agents-mc-2',
    question:
      'Which strategy best reduces latency in multi-modal agents applications?',
    options: [
  ...
  {
    id: 'mmas-multi-modal-agents-mc-3',
    question:
      'What is the best way to ensure quality in production multi-modal agents systems?',
    options: [
  ...
  {
    id: 'mmas-multi-modal-agents-mc-4',
    question: 'How should you handle errors in multi-modal agents systems?',
    options: [
  ...
  {
    id: 'mmas-multi-modal-agents-mc-5',
    question:
      'What monitoring metrics are most critical for multi-modal agents systems?',
    options: [
