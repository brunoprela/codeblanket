export const multimodalragMultipleChoice = [
  {
    id: 'mmas-multi-modal-rag-mc-1',
    question:
      'What is the recommended approach for optimizing costs in multi-modal rag systems?',
    options: [
  ...
  {
    id: 'mmas-multi-modal-rag-mc-2',
    question:
      'Which strategy best reduces latency in multi-modal rag applications?',
    options: [
  ...
  {
    id: 'mmas-multi-modal-rag-mc-3',
    question:
      'What is the best way to ensure quality in production multi-modal rag systems?',
    options: [
  ...
  {
    id: 'mmas-multi-modal-rag-mc-4',
    question: 'How should you handle errors in multi-modal rag systems?',
    options: [
  ...
  {
    id: 'mmas-multi-modal-rag-mc-5',
    question:
      'What monitoring metrics are most critical for multi-modal rag systems?',
    options: [
