export const accessibilityapplicationsMultipleChoice = [
  {
    id: 'mmas-accessibility-applications-mc-1',
    question:
      'What is the recommended approach for optimizing costs in accessibility applications systems?',
    options: [
  ...
  {
    id: 'mmas-accessibility-applications-mc-2',
    question:
      'Which strategy best reduces latency in accessibility applications applications?',
    options: [
  ...
  {
    id: 'mmas-accessibility-applications-mc-3',
    question:
      'What is the best way to ensure quality in production accessibility applications systems?',
    options: [
  ...
  {
    id: 'mmas-accessibility-applications-mc-4',
    question:
      'How should you handle errors in accessibility applications systems?',
    options: [
  ...
  {
    id: 'mmas-accessibility-applications-mc-5',
    question:
      'What monitoring metrics are most critical for accessibility applications systems?',
    options: [
