export const audiotextprocessingMultipleChoice = [
  {
    id: 'mmas-audio-text-processing-mc-1',
    question:
      'What is the recommended approach for optimizing costs in audio + text processing systems?',
    options: [
  ...
  {
    id: 'mmas-audio-text-processing-mc-2',
    question:
      'Which strategy best reduces latency in audio + text processing applications?',
    options: [
  ...
  {
    id: 'mmas-audio-text-processing-mc-3',
    question:
      'What is the best way to ensure quality in production audio + text processing systems?',
    options: [
  ...
  {
    id: 'mmas-audio-text-processing-mc-4',
    question:
      'How should you handle errors in audio + text processing systems?',
    options: [
  ...
  {
    id: 'mmas-audio-text-processing-mc-5',
    question:
      'What monitoring metrics are most critical for audio + text processing systems?',
    options: [
