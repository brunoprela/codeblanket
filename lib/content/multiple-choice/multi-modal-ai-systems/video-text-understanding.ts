export const videotextunderstandingMultipleChoice = [
  {
    id: 'mmas-video-text-understanding-mc-1',
    question:
      'What is the recommended approach for optimizing costs in video + text understanding systems?',
    options: [
  ...
  {
    id: 'mmas-video-text-understanding-mc-2',
    question:
      'Which strategy best reduces latency in video + text understanding applications?',
    options: [
  ...
  {
    id: 'mmas-video-text-understanding-mc-3',
    question:
      'What is the best way to ensure quality in production video + text understanding systems?',
    options: [
  ...
  {
    id: 'mmas-video-text-understanding-mc-4',
    question:
      'How should you handle errors in video + text understanding systems?',
    options: [
  ...
  {
    id: 'mmas-video-text-understanding-mc-5',
    question:
      'What monitoring metrics are most critical for video + text understanding systems?',
    options: [
