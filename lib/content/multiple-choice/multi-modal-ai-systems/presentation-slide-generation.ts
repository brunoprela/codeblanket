export const presentationslidegenerationMultipleChoice = [
  {
    id: 'mmas-presentation-slide-generation-mc-1',
    question:
      'What is the recommended approach for optimizing costs in presentation & slide generation systems?',
    options: [
  ...
  {
    id: 'mmas-presentation-slide-generation-mc-2',
    question:
      'Which strategy best reduces latency in presentation & slide generation applications?',
    options: [
  ...
  {
    id: 'mmas-presentation-slide-generation-mc-3',
    question:
      'What is the best way to ensure quality in production presentation & slide generation systems?',
    options: [
  ...
  {
    id: 'mmas-presentation-slide-generation-mc-4',
    question:
      'How should you handle errors in presentation & slide generation systems?',
    options: [
  ...
  {
    id: 'mmas-presentation-slide-generation-mc-5',
    question:
      'What monitoring metrics are most critical for presentation & slide generation systems?',
    options: [
