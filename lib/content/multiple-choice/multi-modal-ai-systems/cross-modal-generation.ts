export const crossmodalgenerationMultipleChoice = [
  {
    id: 'mmas-cross-modal-generation-mc-1',
    question:
      'What is the recommended approach for optimizing costs in cross-modal generation systems?',
    options: [
  ...
  {
    id: 'mmas-cross-modal-generation-mc-2',
    question:
      'Which strategy best reduces latency in cross-modal generation applications?',
    options: [
  ...
  {
    id: 'mmas-cross-modal-generation-mc-3',
    question:
      'What is the best way to ensure quality in production cross-modal generation systems?',
    options: [
  ...
  {
    id: 'mmas-cross-modal-generation-mc-4',
    question: 'How should you handle errors in cross-modal generation systems?',
    options: [
  ...
  {
    id: 'mmas-cross-modal-generation-mc-5',
    question:
      'What monitoring metrics are most critical for cross-modal generation systems?',
    options: [
