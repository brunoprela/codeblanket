export const buildingmultimodalproductsMultipleChoice = [
  {
    id: 'mmas-building-multi-modal-products-mc-1',
    question:
      'What is the recommended approach for optimizing costs in building multi-modal products systems?',
    options: [
  ...
  {
    id: 'mmas-building-multi-modal-products-mc-2',
    question:
      'Which strategy best reduces latency in building multi-modal products applications?',
    options: [
  ...
  {
    id: 'mmas-building-multi-modal-products-mc-3',
    question:
      'What is the best way to ensure quality in production building multi-modal products systems?',
    options: [
  ...
  {
    id: 'mmas-building-multi-modal-products-mc-4',
    question:
      'How should you handle errors in building multi-modal products systems?',
    options: [
  ...
  {
    id: 'mmas-building-multi-modal-products-mc-5',
    question:
      'What monitoring metrics are most critical for building multi-modal products systems?',
    options: [
