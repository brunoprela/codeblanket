export const imagetextunderstandingMultipleChoice = [
  {
    id: 'mmas-image-text-understanding-mc-1',
    question:
      'What is the recommended approach for optimizing costs in image + text understanding systems?',
    options: [
  ...
  {
    id: 'mmas-image-text-understanding-mc-2',
    question:
      'Which strategy best reduces latency in image + text understanding applications?',
    options: [
  ...
  {
    id: 'mmas-image-text-understanding-mc-3',
    question:
      'What is the best way to ensure quality in production image + text understanding systems?',
    options: [
  ...
  {
    id: 'mmas-image-text-understanding-mc-4',
    question:
      'How should you handle errors in image + text understanding systems?',
    options: [
  ...
  {
    id: 'mmas-image-text-understanding-mc-5',
    question:
      'What monitoring metrics are most critical for image + text understanding systems?',
    options: [
