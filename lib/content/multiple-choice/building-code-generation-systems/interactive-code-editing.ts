...
export const interactivecodeeditingMultipleChoice: MultipleChoiceQuestion[] = [
    ...
    },
    {
        ...
        question:
            'How should multiple simultaneous edit requests be handled?',
        options: [
    ...
    },
    {
        ...
        question:
            'What context should be sent with each edit request?',
        options: [
    ...
    },
    {
        ...
        question:
            'How should generated edits be applied to the editor?',
        options: [
            'Replace entire file',
    ...
    },
    {
        ...
        question:
            'What should happen when LLM generates invalid code?',
        options: [
            'Apply anyway',
