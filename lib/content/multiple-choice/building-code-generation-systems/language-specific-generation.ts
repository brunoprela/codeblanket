...
export const languagespecificgenerationMultipleChoice: MultipleChoiceQuestion[] =
  [
    ...
    },
    {
      ...
      question: 'How should error handling be generated for Python vs Go?',
      options: [
    ...
    },
    {
      ...
      question: 'What should guide typing approach in generated code?',
      options: [
        'Never use types',
    ...
    },
    {
      ...
      question: 'How should concurrency be generated for different languages?',
      options: [
        'Always use threads',
    ...
    },
    {
      ...
      question: 'What should language-specific prompts include?',
      options: [
