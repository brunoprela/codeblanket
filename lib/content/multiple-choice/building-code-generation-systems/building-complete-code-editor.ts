...
export const buildingcompletecodeeditorMultipleChoice: MultipleChoiceQuestion[] =
  [
    {
      id: 'bcgs-editor-mc-1',
      question: 'What architecture should an LLM-powered code editor use?',
      options: [
    ...
    {
      id: 'bcgs-editor-mc-2',
      question: 'How should code context be managed for large projects?',
      options: [
    ...
    {
      id: 'bcgs-editor-mc-3',
      question: 'What features distinguish an excellent LLM code editor?',
      options: [
    ...
    {
      id: 'bcgs-editor-mc-4',
      question: 'How should the editor handle conflicting changes?',
      options: [
