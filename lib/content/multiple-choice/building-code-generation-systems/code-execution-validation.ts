...
export const codeexecutionvalidationMultipleChoice: MultipleChoiceQuestion[] = [
    ...
    },
    {
        ...
        question:
            'What resource limits should be applied to code execution?',
        options: [
            'No limits needed',
            'Only time limits',
    ...
    },
    {
        ...
        question:
            'How should execution results be validated?',
        options: [
    ...
    },
    {
        ...
        question:
            'What should happen when executed code times out?',
        options: [
            'Wait forever',
    ...
    },
    {
        ...
        question:
            'How should dependencies be handled in code execution sandbox?',
        options: [
