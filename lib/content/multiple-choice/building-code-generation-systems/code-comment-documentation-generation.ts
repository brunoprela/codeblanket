...
export const codecommentdocumentationgenerationMultipleChoice: MultipleChoiceQuestion[] =
  [
    {
      id: 'bcgs-docs-mc-1',
      question: 'What makes a good code comment according to best practices?',
      options: [
    ...
    {
      id: 'bcgs-docs-mc-2',
      question: 'What should docstrings include for a function?',
      options: [
    ...
    {
      id: 'bcgs-docs-mc-3',
      question: 'When should LLM generate comments?',
      options: [
