...
export const codereviewbugdetectionMultipleChoice: MultipleChoiceQuestion[] = [
    {
        id: 'bcgs-review-mc-1',
        question:
            'What is the most effective way to use LLMs for code review?',
        options: [
    ...
    },
    {
        id: 'bcgs-review-mc-2',
        question:
            'What categories should automated code review check?',
        options: [
            'Only syntax errors',
    ...
    },
    {
        id: 'bcgs-review-mc-3',
        question:
            'How should LLM-detected issues be prioritized?',
        options: [
    ...
    },
    {
        id: 'bcgs-review-mc-4',
        question:
            'What makes a good code review comment from an LLM?',
        options: [
    ...
    },
    {
        id: 'bcgs-review-mc-5',
        question:
            'Should LLM code review replace human review?',
        options: [
