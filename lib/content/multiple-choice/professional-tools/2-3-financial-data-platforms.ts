export const financialDataPlatformsMultipleChoice = [
  {
    id: '2-3-q1',
    question:
      'A quantitative hedge fund needs superior factor models, cleaner historical data, and strong Excel integration. They have a $15K/year budget per analyst. Which platform is most suitable?',
    options: [
  ...
  },
  {
    id: '2-3-q2',
    question:
      'An investment bank needs to research private company acquisition targets, build comparable company analyses, and create M&A pitch books. Which platform combination is ideal?',
    options: [
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'YCharts Professional ($4,800/year) + Polygon.io for real-time data ($1,200/year) + free sources provides comprehensive coverage within budget. YCharts offers professional screening, charting, and portfolio analytics. Polygon.io provides real-time market data via API for Python integration. Free sources (yfinance, FRED) supplement for historical data. This combo provides 80% of enterprise platform functionality at 25% of the cost. Bloomberg/FactSet are 2-4x over budget. Free sources alone lack professional screening and analytics needed for client-facing fund.',
  },
  {
    id: '2-3-q4',
    question:
      'Which statement BEST describes the key differentiation between Bloomberg Terminal and its main competitors (FactSet, Refinitiv, Capital IQ)?',
    options: [
  ...
  },
  {
    id: '2-3-q5',
    question:
      'A Python developer is building a multi-source data aggregation system. When should they prioritize premium platforms (Bloomberg/FactSet API) over free sources (yfinance)?',
    options: [
