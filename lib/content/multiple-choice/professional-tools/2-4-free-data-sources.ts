export const freeDataSourcesMultipleChoice = [
  {
    id: '2-4-q1',
    question:
      'A student wants to backtest a momentum trading strategy on S&P 500 stocks using 10 years of daily data. Which free data source is most suitable?',
    options: [
  ...
  },
  {
    id: '2-4-q3',
    question:
      'A quantitative researcher needs real-time (sub-second) market data for algorithmic trading. Which statement about free data sources is MOST accurate?',
    options: [
  ...
  },
  {
    id: '2-4-q5',
    question:
      "You're analyzing a company's financials and want to verify Management Discussion & Analysis (MD&A) claims against actual financial performance. Which data source combination is best?",
    options: [
