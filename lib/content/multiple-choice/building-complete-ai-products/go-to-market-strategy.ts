/**
 * Multiple choice questions for Go-to-Market Strategy
 */

import { MultipleChoiceQuestion } from '../../../types';

export const goToMarketStrategyMultipleChoice: MultipleChoiceQuestion[] = [
  {
    id: 'bcap-go-to-market-strategy-mc-1',
    question:
      'What is the most critical consideration when building go-to-market strategy?',
    options: [
  ...
  {
    id: 'bcap-go-to-market-strategy-mc-2',
    question: 'How should you approach scaling go-to-market strategy?',
    options: [
  ...
  {
    id: 'bcap-go-to-market-strategy-mc-3',
    question:
      'What is the best strategy for managing costs in go-to-market strategy?',
    options: [
  ...
  {
    id: 'bcap-go-to-market-strategy-mc-4',
    question:
      'How should errors be handled in production go-to-market strategy?',
    options: [
  ...
  {
    id: 'bcap-go-to-market-strategy-mc-5',
    question: 'What monitoring is essential for go-to-market strategy?',
    options: [
      'Only error logs',
