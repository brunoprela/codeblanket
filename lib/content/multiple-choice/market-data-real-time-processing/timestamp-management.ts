...
export const timestampManagementMultipleChoice: MultipleChoiceQuestion[] = [
  {
    ...
    question:
      'Your system clock drifts +2ms per hour. With hourly NTP sync, what is maximum clock error?',
    options: [
      '±2ms (drift between syncs)',
      '±10ms (NTP accuracy)',
      '±12ms (drift + NTP)',
      '0ms (always synced)',
    ],
