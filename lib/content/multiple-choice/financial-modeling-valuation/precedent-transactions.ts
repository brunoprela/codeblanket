...
export const precedentTransactionsMultipleChoice: MultipleChoiceQuestion[] = [
  {
    id: 'pt-mc-1',
    question:
      'A company trading at $60/share receives an acquisition offer at $80/share. What is the acquisition premium?',
    options: ['25.0%', '33.3%', '20.0%', '75.0%'],
    correctAnswer: 1,
    explanation:
      'Option 2 is correct: 33.3% premium. Formula: Premium = (Offer Price - Trading Price) / Trading Price = ($80 - $60) / $60 = $20 / $60 = 0.333 = 33.3%. Common mistake: Option 1 (25%) incorrectly calculates ($80 - $60) / $80 = 25%—this is wrong denominator (should use unaffected trading price, not offer price). Option 3 (20%) is $20 premium / $80 offer, also wrong denominator. Option 4 (75%) is nonsensical. Interpretation: 33.3% premium is typical for strategic acquisition (range: 25-40%). Represents value of control, synergies, and strategic fit. If premium were only 15%, might suggest friendly deal with limited competition. If 50%+, suggests competitive bidding or hostile takeover.',
  },
  {
    id: 'pt-mc-2',
    question:
      'When comparing precedent transaction multiples to trading comps multiples, which statement is most accurate?',
    options: [
