  ...
  [
    {
      id: 'cca-mc-1',
      question:
        'When calculating Enterprise Value for a comps analysis, which of the following items should be ADDED to market capitalization?',
      options: [
