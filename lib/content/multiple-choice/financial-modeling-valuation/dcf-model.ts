...
export const dcfModelMultipleChoice: MultipleChoiceQuestion[] = [
  ...
  },
  {
    ...
    options: ['33%; No—appropriate balance', '67%; Yes—over-reliance on terminal value', '67%; No—typical for most DCFs', '50%; Yes—should be lower'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['2.5% (in line with long-term U.S. GDP growth)', '3.0% (slightly above GDP to reflect tech industry growth)', '5.0% (reflecting company\'s strong competitive position)', '2.0% (conservative estimate below GDP growth)'],
    correctAnswer: 2,
    explanation:
