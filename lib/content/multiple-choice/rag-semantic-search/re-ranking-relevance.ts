export const reRankingRelevanceMC = {
  title: 'Re Ranking Relevance - Multiple Choice Questions',
  questions: [
    {
      id: 1,
      question:
        'Which of the following best describes the primary purpose of re ranking relevance?',
      options: [
    ...
    },
    {
      id: 2,
      question:
        'In a production RAG system using re ranking relevance, what is the most critical metric to monitor?',
      options: [
    ...
    },
    {
      id: 3,
      question:
        'When implementing re ranking relevance, which approach typically provides the best balance of accuracy and performance?',
      options: [
    ...
    },
    {
      id: 4,
      question:
        'What is the primary challenge when scaling re ranking relevance to millions of documents?',
      options: [
    ...
    },
    {
      id: 5,
      question:
        'Which of the following is NOT a recommended practice for re ranking relevance in production?',
      options: [
