export const vectorDatabasesMC = {
  title: 'Vector Databases - Multiple Choice Questions',
  questions: [
    {
      id: 1,
      question:
        'Which of the following best describes the primary purpose of vector databases?',
      options: [
    ...
    },
    {
      id: 2,
      question:
        'In a production RAG system using vector databases, what is the most critical metric to monitor?',
      options: [
    ...
    },
    {
      id: 3,
      question:
        'When implementing vector databases, which approach typically provides the best balance of accuracy and performance?',
      options: [
    ...
    },
    {
      id: 4,
      question:
        'What is the primary challenge when scaling vector databases to millions of documents?',
      options: [
    ...
    },
    {
      id: 5,
      question:
        'Which of the following is NOT a recommended practice for vector databases in production?',
      options: [
