export const multiIndexRoutingMC = {
  title: 'Multi Index Routing - Multiple Choice Questions',
  questions: [
    {
      id: 1,
      question:
        'Which of the following best describes the primary purpose of multi index routing?',
      options: [
    ...
    },
    {
      id: 2,
      question:
        'In a production RAG system using multi index routing, what is the most critical metric to monitor?',
      options: [
    ...
    },
    {
      id: 3,
      question:
        'When implementing multi index routing, which approach typically provides the best balance of accuracy and performance?',
      options: [
    ...
    },
    {
      id: 4,
      question:
        'What is the primary challenge when scaling multi index routing to millions of documents?',
      options: [
    ...
    },
    {
      id: 5,
      question:
        'Which of the following is NOT a recommended practice for multi index routing in production?',
      options: [
