export const textEmbeddingsDeepDiveMC = {
  title: 'Text Embeddings Deep Dive - Multiple Choice Questions',
  questions: [
    {
      id: 1,
      question:
        'Which of the following best describes the primary purpose of text embeddings deep dive?',
      options: [
    ...
    },
    {
      id: 2,
      question:
        'In a production RAG system using text embeddings deep dive, what is the most critical metric to monitor?',
      options: [
    ...
    },
    {
      id: 3,
      question:
        'When implementing text embeddings deep dive, which approach typically provides the best balance of accuracy and performance?',
      options: [
    ...
    },
    {
      id: 4,
      question:
        'What is the primary challenge when scaling text embeddings deep dive to millions of documents?',
      options: [
    ...
    },
    {
      id: 5,
      question:
        'Which of the following is NOT a recommended practice for text embeddings deep dive in production?',
      options: [
