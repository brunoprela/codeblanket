export const ragEvaluationMC = {
  title: 'Rag Evaluation - Multiple Choice Questions',
  questions: [
    {
      id: 1,
      question:
        'Which of the following best describes the primary purpose of rag evaluation?',
      options: [
    ...
    },
    {
      id: 2,
      question:
        'In a production RAG system using rag evaluation, what is the most critical metric to monitor?',
      options: [
    ...
    },
    {
      id: 3,
      question:
        'When implementing rag evaluation, which approach typically provides the best balance of accuracy and performance?',
      options: [
    ...
    },
    {
      id: 4,
      question:
        'What is the primary challenge when scaling rag evaluation to millions of documents?',
      options: [
    ...
    },
    {
      id: 5,
      question:
        'Which of the following is NOT a recommended practice for rag evaluation in production?',
      options: [
