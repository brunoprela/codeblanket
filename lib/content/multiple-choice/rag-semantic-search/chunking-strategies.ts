export const chunkingStrategiesMC = {
  title: 'Chunking Strategies - Multiple Choice Questions',
  questions: [
    {
      id: 1,
      question:
        'Which of the following best describes the primary purpose of chunking strategies?',
      options: [
    ...
    },
    {
      id: 2,
      question:
        'In a production RAG system using chunking strategies, what is the most critical metric to monitor?',
      options: [
    ...
    },
    {
      id: 3,
      question:
        'When implementing chunking strategies, which approach typically provides the best balance of accuracy and performance?',
      options: [
    ...
    },
    {
      id: 4,
      question:
        'What is the primary challenge when scaling chunking strategies to millions of documents?',
      options: [
    ...
    },
    {
      id: 5,
      question:
        'Which of the following is NOT a recommended practice for chunking strategies in production?',
      options: [
