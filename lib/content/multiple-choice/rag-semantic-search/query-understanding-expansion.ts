export const queryUnderstandingExpansionMC = {
  title: 'Query Understanding Expansion - Multiple Choice Questions',
  questions: [
    {
      id: 1,
      question:
        'Which of the following best describes the primary purpose of query understanding expansion?',
      options: [
    ...
    },
    {
      id: 2,
      question:
        'In a production RAG system using query understanding expansion, what is the most critical metric to monitor?',
      options: [
    ...
    },
    {
      id: 3,
      question:
        'When implementing query understanding expansion, which approach typically provides the best balance of accuracy and performance?',
      options: [
    ...
    },
    {
      id: 4,
      question:
        'What is the primary challenge when scaling query understanding expansion to millions of documents?',
      options: [
    ...
    },
    {
      id: 5,
      question:
        'Which of the following is NOT a recommended practice for query understanding expansion in production?',
      options: [
