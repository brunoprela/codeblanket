export const productionRagSystemsMC = {
  title: 'Production Rag Systems - Multiple Choice Questions',
  questions: [
    {
      id: 1,
      question:
        'Which of the following best describes the primary purpose of production rag systems?',
      options: [
    ...
    },
    {
      id: 2,
      question:
        'In a production RAG system using production rag systems, what is the most critical metric to monitor?',
      options: [
    ...
    },
    {
      id: 3,
      question:
        'When implementing production rag systems, which approach typically provides the best balance of accuracy and performance?',
      options: [
    ...
    },
    {
      id: 4,
      question:
        'What is the primary challenge when scaling production rag systems to millions of documents?',
      options: [
    ...
    },
    {
      id: 5,
      question:
        'Which of the following is NOT a recommended practice for production rag systems in production?',
      options: [
