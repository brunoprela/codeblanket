export const advancedRetrievalStrategiesMC = {
  title: 'Advanced Retrieval Strategies - Multiple Choice Questions',
  questions: [
    {
      id: 1,
      question:
        'Which of the following best describes the primary purpose of advanced retrieval strategies?',
      options: [
    ...
    },
    {
      id: 2,
      question:
        'In a production RAG system using advanced retrieval strategies, what is the most critical metric to monitor?',
      options: [
    ...
    },
    {
      id: 3,
      question:
        'When implementing advanced retrieval strategies, which approach typically provides the best balance of accuracy and performance?',
      options: [
    ...
    },
    {
      id: 4,
      question:
        'What is the primary challenge when scaling advanced retrieval strategies to millions of documents?',
      options: [
    ...
    },
    {
      id: 5,
      question:
        'Which of the following is NOT a recommended practice for advanced retrieval strategies in production?',
      options: [
