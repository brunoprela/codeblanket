export const semanticSearchImplementationMC = {
  title: 'Semantic Search Implementation - Multiple Choice Questions',
  questions: [
    {
      id: 1,
      question:
        'Which of the following best describes the primary purpose of semantic search implementation?',
      options: [
    ...
    },
    {
      id: 2,
      question:
        'In a production RAG system using semantic search implementation, what is the most critical metric to monitor?',
      options: [
    ...
    },
    {
      id: 3,
      question:
        'When implementing semantic search implementation, which approach typically provides the best balance of accuracy and performance?',
      options: [
    ...
    },
    {
      id: 4,
      question:
        'What is the primary challenge when scaling semantic search implementation to millions of documents?',
      options: [
    ...
    },
    {
      id: 5,
      question:
        'Which of the following is NOT a recommended practice for semantic search implementation in production?',
      options: [
