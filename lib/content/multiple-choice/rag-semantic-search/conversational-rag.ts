export const conversationalRagMC = {
  title: 'Conversational Rag - Multiple Choice Questions',
  questions: [
    {
      id: 1,
      question:
        'Which of the following best describes the primary purpose of conversational rag?',
      options: [
    ...
    },
    {
      id: 2,
      question:
        'In a production RAG system using conversational rag, what is the most critical metric to monitor?',
      options: [
    ...
    },
    {
      id: 3,
      question:
        'When implementing conversational rag, which approach typically provides the best balance of accuracy and performance?',
      options: [
    ...
    },
    {
      id: 4,
      question:
        'What is the primary challenge when scaling conversational rag to millions of documents?',
      options: [
    ...
    },
    {
      id: 5,
      question:
        'Which of the following is NOT a recommended practice for conversational rag in production?',
      options: [
