export const moduleProjectOptionsPlatformMC = [
    {
        ...
        question: 'In implementing a Black-Scholes pricing engine, what is the most critical edge case to handle?',
        options: [
    ...
    },
    {
        ...
        question: 'When building a Strategy Builder for options, what is the most important consideration for calculating aggregate portfolio Greeks?',
        options: [
    ...
    },
    {
        ...
        question: 'In a Portfolio Manager risk monitoring system, what should trigger an immediate hedge action?',
        options: [
    ...
    },
    {
        ...
        question: 'In a Backtesting Framework, what is the most realistic way to model option entry/exit prices?',
        options: [
    ...
    },
    {
        ...
        question: 'For the Module Project deliverable, what is the minimum acceptable accuracy for Black-Scholes pricing compared to market prices?',
        options: [
