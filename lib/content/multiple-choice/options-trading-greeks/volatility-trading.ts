export const volatilityTradingMC = [
    {
        ...
        question: 'What is the "volatility risk premium" (VRP) and why does it exist?',
        options: [
    ...
    },
    {
        ...
        question: 'In a VIX futures "contango" market structure, what happens to long VIX positions over time?',
        options: [
    ...
    },
    {
        ...
        question: 'What is the primary risk of VIX Exchange-Traded Products like UVXY and SVXY?',
        options: [
    ...
    },
    {
        ...
        question: 'A "variance swap" is different from a standard option position because:',
        options: [
