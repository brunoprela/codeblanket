export const portfolioGreeksManagementMC = [
    {
        ...
        question: 'When managing a portfolio of options, what does "portfolio delta" represent?',
        options: [
    ...
    },
    {
        ...
        question: 'What is the primary benefit of maintaining positive "portfolio gamma"?',
        options: [
    ...
    },
    {
        ...
        question: 'In stress testing a portfolio, a "-20% stock move" scenario shows a loss of $800,000 on a $5M portfolio. What is the appropriate action?',
        options: [
    ...
    },
    {
        ...
        question: 'P&L attribution analysis shows: Delta +$5,000, Gamma +$2,000, Theta +$500, Vega -$8,000. What was the primary driver of the daily loss?',
        options: [
