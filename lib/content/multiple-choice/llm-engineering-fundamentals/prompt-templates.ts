...
export const prompttemplatesMultipleChoice: MultipleChoiceQuestion[] = [
    {
        id: 'mc1',
        question: 'What is the main advantage of using prompt templates over hard-coded prompts?',
        options: [
    ...
    {
        id: 'mc2',
        question: 'When should you use Jinja2 templates instead of simple f-strings?',
        options: [
            'Always use Jinja2',
    ...
    {
        id: 'mc4',
        question: 'Why is template versioning important for production LLM applications?',
        options: [
    ...
    {
        id: 'mc5',
        question: 'What is the recommended storage for prompt templates in production?',
        options: [
            'Only in code files',
