...
export const localllmdeploymentMultipleChoice: MultipleChoiceQuestion[] = [
  {
    id: 'mc1',
    question:
      'At what monthly API cost does local LLM deployment typically become cost-effective?',
    options: [
      '$100/month',
      '$500/month',
      '$2,000+/month',
  ...
  },
  {
    id: 'mc4',
    question:
      'What GPU memory is needed to run a quantized 8B parameter model?',
    options: ['2GB', '8-16GB', '32GB', '64GB+'],
    correctAnswer: 1,
    explanation:
