...
export const costtrackingoptimizationMultipleChoice: MultipleChoiceQuestion[] =
  [
    ...
    },
    {
      id: 'mc4',
      question:
        'What percentage cache hit rate provides significant cost savings?',
      options: ['5-10%', '30-40%', '70-80%', '95%+'],
      correctAnswer: 1,
      explanation:
    ...
    },
    {
      id: 'mc5',
      question:
        'How can you estimate the cost of an API call before making it?',
      options: [
