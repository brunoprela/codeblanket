...
export const llmapisprovidersMultipleChoice: MultipleChoiceQuestion[] = [
    {
        id: 'mc1',
        question: 'Which LLM provider offers the largest context window as of 2024?',
        options: [
    ...
    {
        id: 'mc2',
        question: 'What is the approximate cost difference between GPT-4 and GPT-3.5 Turbo per 1M tokens?',
        options: [
    ...
    {
        id: 'mc3',
        question: 'When making your first OpenAI API call, which of these is the MINIMUM required?',
        options: [
    ...
    {
        id: 'mc4',
        question: 'What is the main advantage of using a unified client that supports multiple LLM providers?',
        options: [
    ...
    {
        id: 'mc5',
        question: 'Which model would be most cost-effective for simple data extraction from 1000s of documents daily?',
        options: [
