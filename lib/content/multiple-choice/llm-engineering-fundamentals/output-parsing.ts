...
export const outputparsingMultipleChoice: MultipleChoiceQuestion[] = [
    {
        id: 'mc1',
        question: 'What is the main advantage of using JSON mode over regex parsing?',
        options: [
            'JSON mode is faster',
    ...
    {
        id: 'mc4',
        question: 'What should you do if JSON mode returns invalid JSON despite being enabled?',
        options: [
            'Give up immediately',
