...
export const chatcompletionsmessagesMultipleChoice: MultipleChoiceQuestion[] = [
    ...
    {
        id: 'mc4',
        question: 'Which truncation strategy preserves the most important information?',
        options: [
    ...
    {
        id: 'mc5',
        question: 'How should conversation history be stored for multi-session conversations?',
        options: [
