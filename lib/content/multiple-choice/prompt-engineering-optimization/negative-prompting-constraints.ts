  ...
  [
    {
      ...
      question: 'Why are "do NOT" instructions effective?',
      options: [
    ...
    },
    {
      ...
      question: 'What type of constraint is "Do not apologize more than once"?',
      options: [
        'Format constraint',
    ...
    },
    {
      ...
      question: 'Which is an example of a scope constraint?',
      options: [
        '"Be concise"',
    ...
    },
    {
      ...
      question: 'What should you do when constraints are frequently violated?',
      options: [
