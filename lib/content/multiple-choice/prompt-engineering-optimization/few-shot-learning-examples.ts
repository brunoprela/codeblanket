...
export const fewshotlearningexamplesMultipleChoice: MultipleChoiceQuestion[] = [
  {
    ...
    options: ['1-2 examples', '3-5 examples', '10-15 examples', '20+ examples'],
    correctAnswer: 1,
    explanation:
  ...
  {
    id: 'peo-fewshot-mc-2',
    question: 'When ordering examples, which sequence is most effective?',
    options: [
      'Random order',
      'Complex to simple',
      'Simple to complex',
  ...
  {
    id: 'peo-fewshot-mc-3',
    question: 'What is dynamic example selection (RAG for examples)?',
    options: [
  ...
  {
    id: 'peo-fewshot-mc-4',
    question: 'What is the most important characteristic of good examples?',
    options: [
      'They are very long',
  ...
  {
    id: 'peo-fewshot-mc-5',
    question: 'When should you use zero-shot instead of few-shot prompting?',
    options: [
      "Always - it's simpler",
