  ...
  [
    {
      ...
      question: 'What is the most important first step in prompt optimization?',
      options: [
    ...
    },
    {
      ...
      question: 'What is prompt compression primarily used for?',
      options: [
        'Improving accuracy',
    ...
    },
    {
      ...
      question: 'What does LLMLingua do?',
      options: [
