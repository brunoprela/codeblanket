...
export const contextmanagementtruncationMultipleChoice: MultipleChoiceQuestion[] =
  [
    {
      id: 'peo-context-mc-1',
      question: 'What is the typical context window size for GPT-4?',
      options: [
        '4,000 tokens',
        '8,000 tokens',
        '32,000 tokens',
    ...
    {
      id: 'peo-context-mc-2',
      question: 'For code files, which truncation strategy works best?',
      options: [
    ...
    {
      id: 'peo-context-mc-3',
      question: 'What is hierarchical context management?',
      options: [
    ...
    {
      id: 'peo-context-mc-4',
      question: 'What is sliding window processing?',
      options: [
