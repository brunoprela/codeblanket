...
export const outputformatcontrolMultipleChoice: MultipleChoiceQuestion[] = [
  {
    id: 'peo-format-mc-1',
    question: "What is the main advantage of using JSON mode in OpenAI's API?",
    options: [
      'Faster responses',
  ...
  {
    id: 'peo-format-mc-2',
    question: 'What does the Instructor library provide?',
    options: [
  ...
  {
    id: 'peo-format-mc-3',
    question: 'When an LLM output fails validation, what is the best strategy?',
    options: [
  ...
  {
    id: 'peo-format-mc-4',
    question: 'Why is JSON preferred over XML for LLM outputs?',
    options: [
      'JSON is newer',
  ...
  },
  {
    ...
    options: ['1 retry', '3 retries', '10 retries', 'Unlimited retries'],
    correctAnswer: 1,
    explanation:
