...
export const marketRegulationsMultipleChoice: MultipleChoiceQuestion[] = [
  {
    ...
    question:
      'Under Reg NMS Rule 611 (Order Protection Rule), a broker receives a buy order for 1,000 shares. The NBBO is $100.00 bid (NYSE) × $100.10 ask (NASDAQ). The broker executes the order at $100.15 on Cboe. Is this a trade-through violation?',
    options: [
  ...
  },
  {
    ...
    question:
      'A trading algorithm places 10,000 sell orders over a 30-minute period, resulting in 150 actual executions. The order-to-trade ratio is 67:1. Which regulatory concern does this pattern raise?',
    options: [
  ...
  },
  {
    ...
    question:
      'Under Reg NMS Rule 613 (Consolidated Audit Trail), what is the required timestamp precision for reporting high-frequency trading activity?',
    options: [
  ...
  },
  {
    ...
    question:
      'Under MiFID II, a dark pool in the EU exceeds 8% of total trading volume for a particular stock. What action is required?',
    options: [
  ...
  },
  {
    ...
    question:
      'A trader places a large sell order at $100.00, then immediately places 20 buy orders at $99.95, $99.94, $99.93, ... down to $99.76, and cancels them all 200 milliseconds later without execution. This pattern is repeated 50 times in one hour. This is MOST likely an example of:',
    options: [
