...
export const orderBookSimulatorMultipleChoice: MultipleChoiceQuestion[] = [
  {
    ...
    question:
      'In a price-time priority matching engine, three limit buy orders arrive in sequence: Order A: 100 shares @ $100.00 (t=1000ns), Order B: 100 shares @ $100.01 (t=1001ns), Order C: 100 shares @ $100.00 (t=1002ns). A sell market order for 150 shares arrives at t=1003ns. Which orders get filled and in what sequence?',
    options: [
  ...
  },
  {
    ...
    question:
      'A Fill-Or-Kill (FOK) order to buy 5,000 shares @ $150.00 arrives when the order book has: $150.00 ask (3,000 shares), $150.01 ask (1,500 shares), $150.02 ask (2,000 shares). What happens to the FOK order?',
    options: [
  ...
  },
  {
    ...
    question:
      'The matching engine processes 100,000 orders in 2.5 seconds with the following latency distribution: median 15μs, 95th percentile 45μs, 99th percentile 350μs, maximum 12ms. The 12ms outlier is MOST likely caused by:',
    options: [
  ...
  },
  {
    ...
    question:
      'A market maker bot maintains quotes of $100.00 bid / $100.10 ask with 100 shares on each side. After buying 50 shares (now +50 position), how should the bot adjust quotes to manage inventory risk?',
    options: [
  ...
  },
  {
    ...
    question:
      'You are building a production order book simulator and must choose a data structure for storing orders at each price level. The workload is: 80% order additions, 15% cancellations, 5% modifications. Orders at the same price must be served FIFO. Which data structure provides the best performance?',
    options: [
