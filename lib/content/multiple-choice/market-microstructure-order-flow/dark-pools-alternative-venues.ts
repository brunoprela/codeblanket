  ...
  [
    {
      ...
      question:
        'An institutional investor executes a 100,000 share buy order in a dark pool at the midpoint of $50.05 (NBBO: $50.00 bid × $50.10 ask). Compared to buying on a lit exchange at the ask price, what is the total price improvement provided by the dark pool execution?',
      options: [
...
This demonstrates the key value proposition of dark pools: price improvement for both buyers and sellers by matching at the midpoint of the spread.`,
    },
    {
      ...
      question:
        "IEX's 350-microsecond speed bump is designed to protect investors from which specific type of predatory trading strategy?",
      options: [
...
The mechanism works by delaying inbound orders by 350μs while allowing IEX to immediately update quotes when the market moves. This ensures that resting orders are canceled before predatory HFTs can trade against them at stale prices. Without the speed bump, HFTs with faster connections could detect price movements on other venues and race to IEX to exploit investors with orders at old prices.`,
    },
    {
      ...
      question:
        'A smart order router is deciding between routing to a dark pool with 30% historical fill rate (no fees) versus a lit exchange with 95% fill rate (0.3 basis point taker fee). For a 50,000 share order at $100/share, what is the expected cost difference between venues, considering both fill rates and fees?',
      options: [
...
Dark pool expected total cost: $1,050. Lit exchange cost: $1,500. Savings: $1,500 - $1,050 = $450... [detailed breakdown continues]`,
    },
    {
      ...
      question:
        'Information leakage from a dark pool is detected when, after submitting a large buy order, the lit market spread widens from 10 cents to 20 cents and depth decreases by 60%. What is the MOST likely explanation for this behavior?',
      options: [
...
This behavior is extremely costly to the institutional investor because...  [detailed explanation of leakage mechanisms, cost quantification, and mitigation strategies continues]`,
    },
    {
      ...
      question:
        'Under Regulation ATS, which requirement does NOT apply to dark pools in the United States?',
      options: [
