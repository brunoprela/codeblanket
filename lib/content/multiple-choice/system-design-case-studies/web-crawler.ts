...
export const webCrawlerMultipleChoice = [
    {
        question: "You're implementing URL normalization for your crawler's duplicate detection. Which of the following URLs should be considered duplicates after proper normalization: (1) 'HTTP://Example.com:80/Path?b=2&a=1#section', (2) 'http://example.com/path?a=1&b=2', (3) 'http://example.com:443/path?a=1&b=2'?",
        options: [
