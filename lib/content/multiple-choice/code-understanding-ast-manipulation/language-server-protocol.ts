...
export const languageserverprotocolMultipleChoice: MultipleChoiceQuestion[] = [
  {
    ...
    question: 'What problem does LSP solve?',
    options: [
      'Slow code execution',
  ...
  },
  {
    ...
    question: 'How does LSP communicate between client (editor) and server?',
    options: [
      'Shared memory',
  ...
  },
  {
    ...
    question: 'What is incremental document synchronization in LSP?',
    options: [
  ...
  },
  {
    ...
    question: 'What LSP feature provides autocomplete suggestions?',
    options: [
