...
export const symbolresolutionMultipleChoice: MultipleChoiceQuestion[] = [
    {
        ...
        question:
            'What is a symbol table used for in code analysis?',
        options: [
    ...
    },
    {
        ...
        question:
            'How do you find all references to a variable in Python AST?',
        options: [
    ...
    },
    {
        ...
        question:
            'What is the difference between a Name node and a symbol?',
        options: [
            'They are the same',
