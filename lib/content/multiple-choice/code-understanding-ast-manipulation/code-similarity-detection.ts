...
export const codesimilaritydetectionMultipleChoice: MultipleChoiceQuestion[] = [
  {
    ...
    question: 'What is the difference between Type 1 and Type 2 code clones?',
    options: [
  ...
  },
  {
    ...
    question: 'What is tree edit distance?',
    options: [
  ...
  },
  {
    ...
    question: 'Why would you hash AST subtrees for clone detection?',
    options: [
  ...
  },
  {
    ...
    question: 'What is semantic clone detection?',
    options: [
