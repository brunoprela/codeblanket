...
const columnOrientedDatabasesMCQ: Quiz = {
  id: 'column-oriented-databases-mcq',
  title: 'Column-Oriented Databases - Multiple Choice Questions',
  questions: [
    {
      id: 'col-db-mcq-1',
...
export default columnOrientedDatabasesMCQ;
