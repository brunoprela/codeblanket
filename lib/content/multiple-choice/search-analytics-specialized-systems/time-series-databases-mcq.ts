...
const timeSeriesDatabasesMCQ: Quiz = {
  id: 'time-series-databases-mcq',
  title: 'Time-Series Databases - Multiple Choice Questions',
  questions: [
    {
      id: 'tsdb-mcq-1',
...
export default timeSeriesDatabasesMCQ;
