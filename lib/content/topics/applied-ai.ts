/**
 * Applied AI Topic Definition
 */

export const appliedAiTopic = {
  id: 'applied-ai',
  title: 'Applied AI Engineering',
  description:
    'Master building production AI applications - from LLMs and code generation to media creation and deployment at scale',
  icon: '🤖',
  modules: [
