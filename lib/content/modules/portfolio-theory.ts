    ...
    sections: [
        {
            ...
            multipleChoice: modernPortfolioTheoryMC.questions.map(transformMCQuestion),
        },
        {
        ...
        },
        {
            ...
            multipleChoice: sharpeRatioPerformanceMC.questions.map(transformMCQuestion),
        },
        {
            ...
            multipleChoice: meanVarianceOptimizationMC.questions.map(transformMCQuestion),
        },
        {
        ...
        },
        {
            ...
            multipleChoice: assetAllocationStrategiesMC.questions.map(transformMCQuestion),
        },
        {
            ...
            multipleChoice: rebalancingStrategiesMC.questions.map(transformMCQuestion),
        },
        {
            id: factorModels.id,
        ...
        },
        {
            ...
            multipleChoice: backtestingPortfoliosMC.questions.map(transformMCQuestion),
        },
        {
            id: portfolioOptimizationProject.id,
            title: portfolioOptimizationProject.title,
            content: portfolioOptimizationProject.content,
            quiz: portfolioOptimizationProjectQuiz.questions.map(transformQuizQuestion),
            multipleChoice: portfolioOptimizationProjectMC.questions.map(transformMCQuestion),
        },
    ],
    quizzes: [
