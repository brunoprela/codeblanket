export const section2MultipleChoice = {
    title: "Income Statement Analysis - Multiple Choice Questions",
    questions: [
        {
            id: 1,
            question: "A SaaS company reports the following for Q4: Revenue $50M (up 25% YoY), Accounts Receivable $60M (up 40% YoY), Deferred Revenue $80M (down 10% YoY), Operating Cash Flow $45M. What is the PRIMARY concern about this company's financial health?",
            options: [
...
{
    id: 2,
        question: "When comparing gross margins across companies, you observe: Netflix (streaming) 43%, Nike (apparel) 44%, Walmart (retail) 24%, Salesforce (SaaS) 76%. A junior analyst concludes 'Salesforce has the best business model because highest gross margin.' What is the BEST counterargument to this analysis?",
            options: [
...
{
    id: 3,
        question: "A company reports EPS of $5.00, up 20% from last year's $4.17. However, net income only increased 10% from $800M to $880M. What is the MOST likely explanation, and what does it imply about earnings quality?",
            options: [
...
{
    id: 5,
        question: "A company's income statement shows consistent revenue growth of 15% annually, but Days Sales Outstanding (DSO) has increased from 45 days to 75 days over the same period. Your automated system is deciding whether to flag this as a concern. What is the MOST accurate interpretation?",
            options: [
