export const section1MultipleChoice = {
    title: "Financial Statements Fundamentals - Multiple Choice Questions",
    questions: [
        {
            id: 1,
            question: "A company reports Net Income of $100M for the year. Its Retained Earnings increased by only $60M during the same period. Which of the following is the MOST likely explanation?",
            options: [
...
\`\`\``
        ...
        {
            id: 2,
            question: "You're parsing SEC filings using the XBRL API and encounter a company that reported Revenue of $500M in their 10-K but later filed an 10-K/A (amendment) showing Revenue of $480M for the same period. How should your automated system handle this?",
            options: [
...
This is why using the SEC's XBRL API is better than web scraping—the API always provides the most current data.`
        ...
        {
            id: 3,
            question: "When building an integrated 3-statement financial model, which of the following statements is TRUE about the relationship between the statements?",
            options: [
...
**Key Takeaway**: Depreciation's add-back in the Cash Flow Statement is one of the most fundamental linkages in financial modeling and is essential for understanding the difference between accounting earnings and actual cash generation.`
        ...
        {
            id: 4,
            question: "You're analyzing a European company that reports under IFRS and a U.S. company that reports under GAAP. The European company shows PP&E of $1B after a revaluation (mark-to-market) adjustment that increased it by $200M from historical cost. To compare the two companies fairly, you should:",
            options: [
...
**Key Principle**: When comparing across accounting standards, normalize to the **most conservative basis** (usually historical cost) to ensure you're comparing like with like.`
        ...
        {
            id: 5,
            question: "Your automated 10-K parser successfully extracts Apple's Revenue as $394.3B from their FY2022 filing. However, your validation system flags an error because the Balance Sheet totals don't match (Assets = $352.8B vs Liabilities + Equity = $352.5B, a $300M difference). What is the MOST likely cause and best approach?",
            options: [
