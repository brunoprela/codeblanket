export const discussionQuestions = [
    {
        id: '2-3-d1',
        question: 'FactSet costs $12-18K/year vs Bloomberg at $24K/year. Both claim to be the "industry standard" for institutional finance. Analyze the true cost-benefit trade-offs between these platforms for three different use cases: (1) quantitative equity long-short hedge fund, (2) investment banking M&A group, and (3) family office managing $500M across public equities and alternatives. For each use case, justify which platform provides better ROI and why.',
        answer: `**Comprehensive Cost-Benefit Analysis: FactSet vs Bloomberg**
...
Audit your actual workflows and choose accordingly.`
    ...
    {
        id: '2-3-d2',
        question: 'Design a comprehensive data platform strategy for a new quantitative hedge fund launching with $50M AUM. The fund has 3 people (1 PM, 2 quant researchers) and plans to trade US equities using factor-based strategies. Budget for year 1 is $50K for all data/tools. Specify platform choices, justify costs, design the Python data infrastructure, and explain how to scale this setup as AUM grows to $500M over 3 years.',
        answer: `**Comprehensive Data Platform Strategy: Quantitative Hedge Fund Launch**
...
scale as you prove the strategy works and raise capital.`
    },
    {
        ...
        answer: `**Investment Bank Platform Optimization: Bloomberg Reduction Strategy**
