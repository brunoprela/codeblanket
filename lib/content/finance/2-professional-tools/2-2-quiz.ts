export const quizQuestions = [
    {
        id: '2-2-q1',
        question: 'A hedge fund analyst needs to download 10 years of daily adjusted closing prices for the S&P 500 constituents into Excel for a backtesting analysis. Which Bloomberg Excel function is most appropriate?',
        options: [
    ...
    },
    {
        ...
        correctAnswer: 1,
        explanation: 'The integrated ecosystem and network effects are Bloomberg\'s moat. Everyone in institutional finance uses it, creating a communication network (Bloomberg Messenger) that\'s hard to leave. You can get similar data from competitors, but you can\'t instantly message 325,000+ professionals. The integration of real-time data, news, analysis, and communication in one platform with shared workflows makes switching costs extremely high. It\'s not required by regulators or exclusively better data—it\'s the network.'
    },
    {
        id: '2-2-q4',
        question: 'When using the Bloomberg Excel add-in, =BDP() formulas update in real-time during market hours, potentially causing Excel to recalculate frequently and slow down. What is the best solution for a large model with 500+ BDP formulas?',
        options: [
