export const discussionQuestions = [
    {
        id: '2-2-d1',
        question: 'Bloomberg Terminal dominates institutional finance despite costing $24,000/year, while free alternatives like Yahoo Finance and TradingView exist. Analyze Bloomberg\'s competitive moat from a business strategy perspective. Why haven\'t competitors successfully disrupted Bloomberg? Design a strategy for a hypothetical startup trying to compete with Bloomberg in 2024.',
        answer: `**Bloomberg's Unbreakable Moat: A Strategic Analysis**
...
Bloomberg is beatable, but it requires patience, perfect execution, and attacking from a different angle. The direct frontal assault (Reuters, FactSet) failed. The wedge strategy (developer → small fund → enterprise) could work.`
    ...
    {
        id: '2-2-d2',
        question: 'You\'re a quantitative researcher at a startup hedge fund that can\'t afford Bloomberg ($24K/year). Design a complete data stack using free and affordable alternatives that replicates 80% of Bloomberg\'s functionality for equity analysis. Include specific tools, APIs, cost breakdown, and a Python framework for integration.',
        answer: `**Building a "Poor Man's Bloomberg" - Complete Data Stack**
...
For a startup quant fund, this is more than sufficient until you reach $100M+ AUM and can justify Bloomberg's cost.`
    ...
    {
        id: '2-2-d3',
        question: 'You\'re training a new analyst who just joined from a tech company. They\'re proficient in Python and SQL but have never used Bloomberg Terminal. Design a 2-week Bloomberg onboarding program that gets them productive quickly. Include daily learning objectives, specific functions to master, practice exercises, and how to integrate Bloomberg data into their existing Python workflow.',
        answer: `**2-Week Bloomberg Terminal Mastery Program**
