export const equityMarketsMultipleChoiceQuestions = [
  {
    id: 1,
    question:
      'A stock is trading with a bid of $50.00 (size: 200 shares) and an ask of $50.05 (size: 300 shares). If you place a market order to buy 500 shares, what is the MOST likely outcome?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      "A market BUY order takes liquidity from the ask (sell) side of the order book. You'll first match with the 300 shares available at $50.05, then you'll need to 'walk up the book' to fill the remaining 200 shares at the next price level, which will be higher. This is called **price slippage** and is why large market orders can be expensive on illiquid stocks.",
    difficulty: 'intermediate',
  },
  {
    id: 2,
    question:
      "Company A's stock trades at $200 per share with 1 billion shares outstanding. Company B's stock trades at $50 per share with 6 billion shares outstanding. Which statement is TRUE?",
    options: [
