export const derivativesMultipleChoiceQuestions = [
    {
        id: 1,
        question: "A trader has a long position in oil futures contracts (1,000 barrels per contract) at $80/barrel. The current price is $85/barrel. With initial margin of $8,000 per contract and maintenance margin of $6,000, what happens if oil drops to $75/barrel the next day?",
        options: [
