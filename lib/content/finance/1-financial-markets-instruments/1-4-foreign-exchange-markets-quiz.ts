export const foreignExchangeMultipleChoiceQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      "In EUR/USD, EUR is the BASE currency (left) and USD is the QUOTE currency (right). The quote tells you how many quote currency units per 1 base currency unit. So EUR/USD = 1.0850 means **1 EUR = 1.0850 USD**. If you want to buy 1,000 EUR, you need to pay 1,000 × 1.0850 = 1,085 USD. **Common mistake**: Thinking the first currency is always the one you're measuring in dollars. USD/JPY = 150 means 1 USD = 150 JPY (NOT 1 JPY = 150 USD). Always read as: 1 unit of BASE = X units of QUOTE.",
    difficulty: 'beginner',
  },
  {
    id: 2,
    question:
      'You enter a carry trade: borrow JPY at 0.1% and invest in AUD at 4.5%. You hold for one year. AUD/JPY stays exactly flat (no FX movement). Your return is approximately:',
    options: [
  ...
  },
  {
    id: 5,
    question:
      'The FX market trades $7.5 trillion daily, making it the largest financial market. Most of this volume comes from:',
    options: [
