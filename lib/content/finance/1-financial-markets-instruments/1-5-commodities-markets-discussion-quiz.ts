export const commoditiesDiscussionQuestions = [
  {
    id: 1,
    question:
      'On April 20, 2020, WTI crude oil futures went to -$37/barrel. Design a trading system that could have detected this scenario in advance and either (1) avoided the loss or (2) profited from it. Include monitoring of storage levels, open interest on expiring contracts, and emergency position-closing logic.',
...
`,
  },
  {
    id: 2,
    question:
      'Design a commodity index fund that tracks a basket of commodities (energy, metals, agriculture) with intelligent futures rolling to minimize contango losses. Compare your approach to existing products like DBC, DJP, and discuss why most commodity ETFs underperform spot commodity prices.',
...
`,
  },
  {
    id: 3,
    question:
      'A gold mining company produces 100,000 ounces annually. Design a comprehensive hedging program using futures, options, and potentially streaming agreements. Balance protecting downside (price crashes) while maintaining upside exposure. Include scenario analysis and comparison to unhedged production.',
...
export const commoditiesMultipleChoiceQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      "The airline **lost money on the futures hedge** (bought/locked in high, market fell), BUT **overall fuel costs still decreased** because 40% of fuel was unhedged (benefited from price drop). **Math example**: Annual fuel: 100M gallons at initially $3/gal = $300M. Hedge 60% at $3.10. Prices fall to $2.10 (-30%). Hedged (60M gal): Pay $3.10 = $186M. Unhedged (40M gal): Pay $2.10 = $84M. Total: $270M vs $210M unhedged. Lost $60M vs unhedged, but still $30M better than original $300M. **Why hedge then?** PROTECTION against prices RISING, not falling. Hedging is INSURANCE - you pay a cost to avoid catastrophic losses. **Real example**: Southwest Airlines hedged heavily in 2000s, saved billions when oil spiked to $140. Other airlines that didn't hedge went bankrupt. Hedging isn't about maximizing gains, it's about ensuring survival.",
    difficulty: 'advanced',
  },
];
