export const fixedIncomeMultipleChoiceQuestions = [
    {
        id: 1,
        question: "A 10-year Treasury bond with a 4% coupon is currently priced at $950 (below par value of $1,000). What can you conclude about the current market yield?",
        options: [
    ...
    },
    {
        ...
        correctAnswer: 1,
        explanation: "An **inverted yield curve** (2-year yield > 10-year yield) has predicted **every U.S. recession** in the past 50 years, typically 12-18 months in advance. **Why it happens**: Investors expect a recession → Fed will cut rates → future short-term rates will be lower → long-term bonds become attractive (locking in current rates) → demand for long bonds pushes their prices up and yields down. **Example**: In 2022-2023, the curve inverted (2Y at 5%, 10Y at 4%) as markets anticipated Fed rate cuts due to slowing economy. **Key**: The yield curve is one of the most reliable recession predictors.",
        difficulty: "intermediate"
    },
    {
        id: 4,
        question: "A bond has a duration of 7 years. If interest rates rise by 1%, approximately how much will the bond's price change?",
        options: [
        ...
        correctAnswer: 1,
        explanation: "**Duration** measures interest rate sensitivity: **Price Change ≈ -Duration × Yield Change**. If duration = 7 years and rates rise 1%, price change ≈ -7 × 1% = **-7%**. The negative sign shows the **inverse relationship** between yields and prices. **Intuition**: Longer duration = more sensitive to rate changes. A 2-year duration bond would only lose 2%, while a 15-year duration bond would lose 15%. **Why this matters**: In 2022 when Fed raised rates rapidly, long-duration bond funds (10+ years) lost 20-30% while short-duration funds lost only 2-5%. Duration is THE key risk metric for bond portfolios.",
        difficulty: "beginner"
    },
    {
        id: 5,
        question: "A corporate bond is rated BBB by S&P. The company's financial situation deteriorates and the rating is downgraded to BB. What happens immediately?",
        options: [
