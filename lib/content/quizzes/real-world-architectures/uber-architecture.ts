...
export const uberarchitectureQuiz = [
  {
    id: 'q1',
    question:
      'Explain how Uber uses H3 geospatial indexing to find nearby drivers efficiently. Why is this better than calculating distance to all drivers?',
    sampleAnswer:
