...
const timeSeriesDatabasesDiscussionQuiz: Quiz = {
  id: 'time-series-databases-discussion',
  title: 'Time-Series Databases - Discussion Questions',
  questions: [
    {
...
export default timeSeriesDatabasesDiscussionQuiz;
