export const buildingCursorForExcelFinanceQuiz = [
  ...
  {
    id: 'bcap-building-cursor-for-excel-finance-q-2',
    question:
      'What are the key performance bottlenecks in building cursor for excel & finance and how would you address them? Include specific metrics and optimization strategies.',
    sampleAnswer:
  ...
  {
    id: 'bcap-building-cursor-for-excel-finance-q-3',
    question:
      'How would you handle failure scenarios in building cursor for excel & finance? Design a comprehensive error handling and recovery strategy including retries, fallbacks, and user communication.',
    sampleAnswer:
