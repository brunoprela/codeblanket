...
export const ticketmasterQuiz = [
    ...
    {
        question: "Design a virtual queue system for Ticketmaster that can handle 500,000 users trying to access a sale that opens at 10:00 AM for 10,000 tickets. How would you assign queue positions fairly, gradually admit users to the purchase flow, and dynamically adjust admission rates based on system load?",
