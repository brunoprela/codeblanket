export const realOptionsValuationQuiz = [
  ...
  {
    id: 'rov-q-2',
    question: 'A manufacturing plant investment has NPV = $10M. Adding expansion capacity (for $5M extra) allows doubling production if demand grows 30%+. Expansion option value = $12M (using real options model). Should you build with expansion capacity?',
    sampleAnswer: 'Expansion option analysis: Base plant: NPV = $10M. Plant with expansion capacity: Cost = $5M extra, Option value = $12M, Net benefit = $12M - $5M = $7M. Total value with flexibility: $10M + $7M = $17M. Decision: Build with expansion capacity—increases value by 70%. Key insight: Pay $5M for growth option worth $12M.',
    keyPoints: [
