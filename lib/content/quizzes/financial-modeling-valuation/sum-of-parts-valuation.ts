export const sumOfPartsValuationQuiz = [
  {
    id: 'sotp-q-1',
    question: 'A conglomerate has 3 segments: Consumer (60% revenue, 12x EV/EBITDA), Tech (30% revenue, 25x EV/EBITDA), Industrial (10% revenue, 8x EV/EBITDA). Current company trades at aggregate 15x EV/EBITDA. Calculate SOTP valuation and conglomerate discount. What drives the discount?',
    sampleAnswer: 'SOTP vs aggregate valuation: Assume total EBITDA = $1B. Consumer: $600M EBITDA × 12x = $7.2B. Tech: $300M EBITDA × 25x = $7.5B. Industrial: $100M EBITDA × 8x = $0.8B. SOTP EV = $15.5B. Current valuation: $1B EBITDA × 15x = $15B. Conglomerate discount: ($15.5B - $15B) / $15.5B = 3.2%. Drivers: (1) Market applies average multiple (15x) instead of segment-specific. (2) Tech segment (25x) gets dragged down by lower-multiple segments. (3) Complexity discount (investors don\'t understand diversification). Value unlock: Spin off tech segment → trades at 25x = $7.5B standalone vs $4.5B embedded.',
    keyPoints: [
