...
export const csvstructureddataQuiz = [
  ...
  },
  {
    id: 'fpdu-csv-q-2',
    question:
      'How would you automatically detect CSV delimiter, encoding, and data types for unknown CSV files?',
    hint: 'Think about sniffing, validation, and fallback strategies.',
    sampleAnswer:
      'Auto-detection strategy: (1) Use csv.Sniffer to detect delimiter from sample. (2) Try UTF-8 first, fallback to latin-1, then chardet for detection. (3) Use pandas infer_objects() or pd.to_numeric() for type detection. (4) Validate detected settings produce sensible results. (5) Provide confidence scores for detections. (6) Allow manual override if auto-detection fails.',
    keyPoints: [
  ...
  },
  {
    id: 'fpdu-csv-q-3',
    question:
      'Compare CSV, JSON, and JSONL for data exchange in LLM applications. When would you use each format?',
    ...
    keyPoints: [
      'CSV: tabular, simple, Excel-friendly',
      'JSON: nested, hierarchical, complex',
      'JSONL: streaming, large files, logs',
