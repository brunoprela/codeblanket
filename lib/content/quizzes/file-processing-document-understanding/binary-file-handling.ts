...
export const binaryfilehandlingQuiz = [
  ...
  },
  {
    id: 'fpdu-binary-q-3',
    question:
      'How would you extract data from a SQLite database file for LLM processing?',
    hint: 'Consider table discovery, data extraction, relationship preservation, and format conversion.',
    sampleAnswer:
      'SQLite extraction: (1) Connect with sqlite3 library. (2) List tables from sqlite_master. (3) Extract each table to pandas DataFrame. (4) Identify relationships via foreign keys. (5) Convert to LLM-friendly format (markdown tables or JSON). (6) Include schema information for context. (7) Handle large tables with chunking. (8) Preserve data types and nulls.',
    keyPoints: [
      'List tables from sqlite_master',
      'Extract to pandas DataFrames',
      'Convert to LLM-friendly format',
      'Include schema for context',
