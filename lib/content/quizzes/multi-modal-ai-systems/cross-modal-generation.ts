export const crossmodalgenerationQuiz = [
  ...
  {
    id: 'mmas-cross-modal-generation-q-2',
    question:
      'Explain the main challenges and solutions for cross-modal generation in production. Include cost optimization, latency reduction, and accuracy improvement strategies.',
  ...
  {
    id: 'mmas-cross-modal-generation-q-3',
    question:
      'Design an evaluation framework for cross-modal generation systems. What metrics would you track, how would you collect ground truth data, and how would you continuously improve the system?',
