export const audiotextprocessingQuiz = [
  ...
  {
    id: 'mmas-audio-text-processing-q-2',
    question:
      'Explain the main challenges and solutions for audio + text processing in production. Include cost optimization, latency reduction, and accuracy improvement strategies.',
  ...
  {
    id: 'mmas-audio-text-processing-q-3',
    question:
      'Design an evaluation framework for audio + text processing systems. What metrics would you track, how would you collect ground truth data, and how would you continuously improve the system?',
