export const presentationslidegenerationQuiz = [
  ...
  {
    id: 'mmas-presentation-slide-generation-q-2',
    question:
      'Explain the main challenges and solutions for presentation & slide generation in production. Include cost optimization, latency reduction, and accuracy improvement strategies.',
  ...
  {
    id: 'mmas-presentation-slide-generation-q-3',
    question:
      'Design an evaluation framework for presentation & slide generation systems. What metrics would you track, how would you collect ground truth data, and how would you continuously improve the system?',
