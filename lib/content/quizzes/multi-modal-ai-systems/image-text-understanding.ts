export const imagetextunderstandingQuiz = [
  ...
  {
    id: 'mmas-image-text-understanding-q-2',
    question:
      'Explain the main challenges and solutions for image + text understanding in production. Include cost optimization, latency reduction, and accuracy improvement strategies.',
  ...
  {
    id: 'mmas-image-text-understanding-q-3',
    question:
      'Design an evaluation framework for image + text understanding systems. What metrics would you track, how would you collect ground truth data, and how would you continuously improve the system?',
