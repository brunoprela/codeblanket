export const multimodalagentsQuiz = [
  ...
  {
    id: 'mmas-multi-modal-agents-q-2',
    question:
      'Explain the main challenges and solutions for multi-modal agents in production. Include cost optimization, latency reduction, and accuracy improvement strategies.',
  ...
  {
    id: 'mmas-multi-modal-agents-q-3',
    question:
      'Design an evaluation framework for multi-modal agents systems. What metrics would you track, how would you collect ground truth data, and how would you continuously improve the system?',
