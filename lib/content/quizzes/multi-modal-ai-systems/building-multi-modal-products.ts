export const buildingmultimodalproductsQuiz = [
  ...
  {
    id: 'mmas-building-multi-modal-products-q-2',
    question:
      'Explain the main challenges and solutions for building multi-modal products in production. Include cost optimization, latency reduction, and accuracy improvement strategies.',
  ...
  {
    id: 'mmas-building-multi-modal-products-q-3',
    question:
      'Design an evaluation framework for building multi-modal products systems. What metrics would you track, how would you collect ground truth data, and how would you continuously improve the system?',
