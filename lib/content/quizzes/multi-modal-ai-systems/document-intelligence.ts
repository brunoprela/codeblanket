export const documentintelligenceQuiz = [
  ...
  {
    id: 'mmas-document-intelligence-q-2',
    question:
      'Explain the main challenges and solutions for document intelligence in production. Include cost optimization, latency reduction, and accuracy improvement strategies.',
  ...
  {
    id: 'mmas-document-intelligence-q-3',
    question:
      'Design an evaluation framework for document intelligence systems. What metrics would you track, how would you collect ground truth data, and how would you continuously improve the system?',
