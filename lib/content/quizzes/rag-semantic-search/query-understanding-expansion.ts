export const queryUnderstandingExpansionQuiz = {
  title: 'Query Understanding Expansion - Discussion Questions',
  questions: [
    {
      id: 1,
      question: `Describe how you would design a production query understanding expansion system that handles millions of queries per day. What are the key architectural decisions and trade-offs you need to consider?`,
    ...
    {
      id: 2,
      question: `Compare and contrast different approaches to query understanding expansion. When would you choose one approach over another, and what metrics would you use to evaluate the decision?`,
    ...
    {
      id: 3,
      question: `What are the most common failure modes when implementing query understanding expansion in production, and how would you detect and mitigate them?`,
