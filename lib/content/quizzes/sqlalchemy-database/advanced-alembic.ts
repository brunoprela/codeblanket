...
export const advancedAlembicQuiz = [
  {
    ...
    question:
      'Explain how to create a custom Alembic operation for creating database views. Include: (1) why views need custom operations, (2) complete implementation with upgrade/downgrade, (3) handling dependencies, (4) testing strategy.',
    ...
    keyPoints: [
      'Views not auto-detected',
      'Custom operation with @register_operation',
      'Test: create, query, drop',
    ],
  },
  {
    id: 'sql-adv-alembic-q-2',
    question:
      'Design a migration strategy for renaming a table with foreign key constraints from other tables. Address all constraint recreation steps.',
  ...
  },
  {
    ...
    question:
      'Explain batch operations in Alembic for SQLite and when they are necessary. Include limitations and workarounds.',
    ...
    keyPoints: [
      'SQLite ALTER TABLE limited',
      'Batch: temp table + copy + rename',
