...
export const orderTypesExecutionQuiz = [
    {
        id: 'fm-1-11-q-1',
        question: "Design a smart order routing algorithm that chooses between market orders (immediate execution, high slippage) vs limit orders (better price, uncertain fill) vs iceberg orders (hide size, minimize impact). Include decision logic based on urgency, volatility, and order size.",
    ...
    {
        id: 'fm-1-11-q-2',
        question: "VWAP and TWAP algorithms are industry standard for institutional orders. Compare their execution profiles. Design a participation rate algorithm (trade 10% of market volume) with anti-gaming logic to detect and avoid predatory HFT strategies.",
    ...
    {
        id: 'fm-1-11-q-3',
        question: "Stop-loss orders can trigger cascading liquidations during flash crashes (2010: Dow -1000pts). Design a 'smart stop' system using volatility-adjusted stops, market impact awareness, and circuit breaker detection to avoid getting stopped out unnecessarily.",
