export const liquidityMarketImpactQuiz = [
  {
    id: 'fm-1-13-q-1',
    question:
      "Kyle\'s Lambda measures permanent market impact: ΔPrice = λ × Quantity. Design a real-time market impact estimation system. How do you distinguish temporary impact (recovers) vs permanent impact (information-driven)? Build a pre-trade cost estimator.",
  ...
  },
  {
    id: 'fm-1-13-q-2',
    question:
      'Almgren-Chriss optimal execution minimizes cost+risk trade-off. Fast execution → high impact, slow → price risk. Build an optimal execution scheduler that balances these. How does volatility affect the optimal schedule?',
  ...
  },
  {
    id: 'fm-1-13-q-3',
    question:
      'Dark pools provide "lit-seeking" functionality to find hidden liquidity. Design a multi-venue liquidity aggregation system. How do you prevent information leakage when pinging multiple venues? What\'s the trade-off between fill rate and information leakage?',
