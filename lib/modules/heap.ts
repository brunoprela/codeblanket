...
- Top K frequent elements`,
            ...
            multipleChoice: [
                ...
                {
                    id: 'mc4',
                    question: 'What is the surprising time complexity of heapify (building a heap from an array)?',
                    options: [
                        'O(N log N)',
                        'O(N)',
                        'O(log N)',
...
def heapq_examples():
    ...
    max_val = -heapq.heappop(max_heap)  # 5`,
            ...
            multipleChoice: [
                ...
                {
                    id: 'mc2',
                    question: 'In extract-min/max, why do we move the last element to the root?',
                    options: [
                        'For speed',
                ...
                {
                    id: 'mc4',
                    question: 'What is the time complexity of peek (viewing root without removal)?',
                    options: [
                        'O(log N)',
                        'O(1)',
                        'O(N)',
...
- Iterative heapify: O(1) extra space`,
            ...
            multipleChoice: [
                ...
                {
                    id: 'mc2',
                    question: 'What is the complexity of finding the Kth largest element using a heap?',
                    options: [
                        'O(K)',
                        'O(N log K)',
                        'O(N)',
                ...
                {
                    id: 'mc4',
                    question: 'How does heap compare to a sorted array for priority queue operations?',
                    options: [
                        'Same performance',
