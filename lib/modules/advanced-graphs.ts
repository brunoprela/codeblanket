...
- Web crawling → SCC`,
            ...
            multipleChoice: [
                {
                    id: 'mc1',
                    question: 'What distinguishes advanced graph algorithms from basic traversals?',
                    options: [
                        'Just faster',
...
def count_components(edges, n):
    ...
    return uf.count_components()`,
            ...
            multipleChoice: [
                ...
                {
                    id: 'mc5',
                    question: 'What is the amortized time complexity of Union-Find with optimizations?',
                    options: [
                        'O(log N)',
