...
6. **Closest First**: Select nearest/closest element`,
      ...
      multipleChoice: [
        ...
        },
        {
          id: 'mc2',
          question:
            'What two properties must hold for a greedy algorithm to work?',
          options: [
            'Fast and simple',
    ...
    return jumps`,
      ...
      multipleChoice: [
        ...
        },
        {
          id: 'mc3',
          question:
            'In two-pointer greedy problems, what is the typical strategy?',
          options: [
...
Modify input instead of creating copies.`,
      ...
      multipleChoice: [
        ...
        },
        {
          id: 'mc5',
          question:
            'How does greedy complexity compare to DP for same problems?',
          options: [
            'Always the same',
      ...
      multipleChoice: [
        {
          id: 'mc1',
          question:
            'What is the first step in the activity selection template?',
          options: [
            'Count activities',
...
- Task Scheduler`,
      ...
      multipleChoice: [
        ...
        },
        {
          id: 'mc2',
          question:
            'What should you clarify first in a greedy interview problem?',
          options: [
            'Complexity only',
