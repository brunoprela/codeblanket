...
- Subset generation and manipulation`,
      ...
      multipleChoice: [
        ...
        },
        {
          id: 'mc2',
          question:
            'When should you use bit manipulation over regular operations?',
          options: [
            'Always',
...
print(f"Right shift: {a >> 1}")  # 5  (divide by 2)`,
      ...
      multipleChoice: [
        ...
        },
        {
          id: 'mc2',
          question:
            'What does XOR (^) operator do and what is its key property?',
          options: [
            'Multiplies',
...
- Not considering edge cases (0, negative numbers)`,
      ...
      multipleChoice: [
        ...
        },
        {
          id: 'mc2',
          question:
            'When should you consider bit manipulation in an interview?',
          options: [
            'Always',
        ...
        },
        {
          id: 'mc5',
          question:
            'How should you communicate your bit manipulation solution?',
          options: [
            'Just code',
