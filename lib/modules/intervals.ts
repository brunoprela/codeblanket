...
- Merge adjacent intervals`,
      ...
      multipleChoice: [
        ...
        },
        {
          id: 'mc2',
          question:
            'Why is sorting usually the first step in interval problems?',
          options: [
...
Sort by end time for scheduling problems.`,
      ...
      multipleChoice: [
        ...
        },
        {
          id: 'mc2',
          question:
            'What is the space complexity of in-place interval merging?',
          options: [
            'O(N)',
...
\`\`\``,
      ...
      multipleChoice: [
        ...
        },
        {
          id: 'mc2',
          question:
            'In the insert interval template, what are the three phases?',
          options: [
            'Sort, merge, return',
...
- My Calendar II`,
      ...
      multipleChoice: [
        ...
        },
        {
          id: 'mc5',
          question:
            'What is a good practice progression for interval problems?',
          options: [
            'Start with hardest',
