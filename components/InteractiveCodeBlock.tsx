        ...
        return (
            <div className="group relative my-4">
                ...
                <button
                    ...
                    className="absolute bottom-3 right-3 flex items-center gap-2 rounded-lg bg-[#bd93f9] px-3 py-1.5 text-xs font-semibold text-[#282a36] shadow-lg transition-all hover:bg-[#bd93f9]/90 hover:scale-105 opacity-0 group-hover:opacity-100"
                >
        ...
        <div className="my-4 rounded-lg border-2 border-[#bd93f9] bg-[#282a36]">
            ...
            {pyodideLoading && (
                <div className="border-b border-[#44475a] bg-[#bd93f9]/10 p-3">
                    <div className="flex items-center gap-2 text-sm">
                        ...
                        <span className="text-[#bd93f9]">Loading Python environment...</span>
                    </div>
                </div>
            )}
            ...
            {output && (
                <div className="border-t border-[#44475a] bg-[#1e1f29] p-4">
                    <div className="mb-2 text-sm font-semibold text-[#bd93f9]">Output:</div>
                    <pre className="whitespace-pre-wrap font-mono text-sm text-[#f8f8f2]">
                        {output}
                    </pre>
                </div>
            )}
